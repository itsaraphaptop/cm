	    ...
	    <div class="row">
			<div  class="col-md-4">
				<div class="container-fluid" style="margin-top: 20px;">
					<h5 class="dis1"><p>Construction ERP</p></h5>
				</div>
			</div>
...
<?php 
  if($login_status != null  && $login_status['status'] == false){
?>
    <center>
      <div class="alert alert-danger " style="width: 500px" role="alert">
        <strong>เตือน !!</strong> <?=$login_status['message'] ?>
      </div>
    </center>
<?php      
  }
?>
    ...
    <!-- <img src="http://Masterinnovation.com/Master.png"> -->
    <p class="dis1">Sign in to ERP</p>

	<form class="form" action="<?php echo base_url() ?>index.php/auth/companylist" method="POST">
			<div class="form-group">
										<!-- <select class="text" name="compcode" >
    	...
    	<a href="#" style="text-decoration:none; color: #fff;"><p>Forgot User & Password?</p></a>
	</div>
