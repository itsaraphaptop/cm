...
<div class="page-header">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Home</span> - รายงานทรัพย์สิน : แยกตามโครงการ</h4>
            </div>
       ...
       <div class="content">
          ...
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h4 class="panel-title">รายงานทรัพย์สิน : แยกตามโครงการ</h4>
              <div class="heading-elements">
                <ul class="icons-list">
...
<form action="<?php echo base_url(); ?>index.php/asset_active/reportfa_p" method="post">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <input type="text" readonly="" class="form-control" value="<?php echo $project_name; ?>">
                      ...
                      <a href="<?php echo base_url(); ?>index.php/asset_active/reportfa_projectall/<?php echo $project_id; ?>" class="btn btn-info btn-sm"><span class="icon-shredder"></span> ทรัพย์สินทั้งหมด</a>
                            </span>
                  </div>
