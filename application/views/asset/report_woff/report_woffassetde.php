...
<form action="<?php echo base_url(); ?>index.php/asset_active/Report_woffassetde" method="post">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <a href="<?php echo base_url(); ?>index.php/asset_active/Report_woffassetall/<?php echo $department_id; ?>" class="btn btn-info btn-sm"><span class="icon-shredder"></span> ทรัพย์สินทั้งหมด</a>
                            </span>
                  </div>
