 <div class="page-header">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Home</span> - รายงานการ Write OFF</h4>
            </div>
          ...
          <div class="breadcrumb-line">
            <ul class="breadcrumb">
              ...
              <li class="active"> รายงานการ Write OFF</li>
            </ul>
  ...
  <div class="content">
          ...
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h4 class="panel-title">รายงานการ Write OFF</h4>
              <div class="heading-elements">
                <ul class="icons-list">
...
<form action="<?php echo base_url(); ?>index.php/asset_active/wfassdate" method="post">
              <div class="row">
