...
<div class="page-header">
          ...
          <div class="breadcrumb-line">
            <ul class="breadcrumb">
              ...
              <li class="active">รายงานการ Write OFF : แยกตามโครงการ/แผนก/แผนก</li>
            </ul>
       ...
       <div class="content">
          ...
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h4 class="panel-title">รายงานการ Write OFF : แยกตามโครงการ/แผนก</h4>
              <div class="heading-elements">
                <ul class="icons-list">
...
<form action="<?php echo base_url(); ?>index.php/asset_active/Report_woffassetpj" method="post">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <input type="text" readonly="" class="form-control" value="<?php echo $project_name; ?>">
                      ...
                      <a href="<?php echo base_url(); ?>index.php/asset_active/Report_woffassetpjall/<?php echo $project_id; ?>" class="btn btn-info btn-sm"><span class="icon-shredder"></span> ทรัพย์สินทั้งหมด</a>
                            </span>
                  </div>
