<div class="page-header">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Home</span> - รายงานทรัพย์สิน : แยกตามประเภททรัพย์สิน</h4>
            </div>
          ...
          <div class="breadcrumb-line">
            <ul class="breadcrumb">
              ...
              <li class="active">รายงานทรัพย์สิน : แยกตามประเภททรัพย์สิน</li>
            </ul>
...
<form action="<?php echo base_url(); ?>index.php/asset_active/reportatt" method="post">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-lg-5" id="assethide2">
                    <div class="input-group">
