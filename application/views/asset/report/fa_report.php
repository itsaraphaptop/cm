<div class="page-header">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Home</span> - รายงานทรัพย์สิน : แยกตามรหัสทรัพย์สิน</h4>
            </div>
          ...
          <div class="breadcrumb-line">
            <ul class="breadcrumb">
              ...
              <li class="active">รายงานทรัพย์สิน : แยกตามรหัสทรัพย์สิน</li>
            </ul>
 ...
 <div class="content">
          ...
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h4 class="panel-title">รายงานทรัพย์สิน : แยกตามรหัสทรัพย์สิน</h4>
              <div class="heading-elements">
                <ul class="icons-list">
...
<form action="<?php echo base_url(); ?>index.php/asset_active/reportfa" method="post">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-lg-2 control-label">Asset Code :</label>
                   <div class="col-lg-5" id="assethide1">
                    <div class="input-group">
