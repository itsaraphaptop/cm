 ...
 <div class="page-header">
          ...
          <div class="breadcrumb-line">
            <ul class="breadcrumb">
              ...
              <li class="active"> รายงานการโอนย้ายทรัพย์สิน</li>
            </ul>
  ...
  <div class="content">
          ...
          <div class="panel panel-flat">
            <div class="panel-heading">
              <h4 class="panel-title">รายงานการโอนย้ายทรัพย์สิน : แยกตามโครงการ</h4>
              <div class="heading-elements">
                <ul class="icons-list">
...
<form action="<?php echo base_url(); ?>index.php/asset_active/report_tfpro" method="post">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                    <input type="text" readonly="" class="form-control" value="<?php echo $project_name; ?>">
                            <input type="hidden" class="form-control" id="project_code" name="project_code" value="<?php echo $project_id; ?>">                     
                    </div>
                  </div>
                </div>
             ...
             <div class="row">
               ...
               เลือก Tranfer Code 
                    <div class="input-group"> 
                    <input type="text" class="form-control input-sm" name="tfc" id="tfc" readonly="">
                  
                    <span class="input-group-btn">
                       <button type="button" data-toggle="modal" data-target="#tfcc" class="tfcc btn btn-default btn-icon btn-xs"><i class="icon-search4"></i></button>
                    </span>
                    </div>
              </div>

              <div class="col-lg-3" id="assethide3">
                    <label class="control-label">&nbsp;</label>
                    <div class="input-group">
                    <input type="text" class="form-control input-sm" name="loid" id="fa_locationid" readonly="" required="true">
                    <input type="text" class="form-control input-sm" name="loname" id="fa_locationname" readonly="">
                      <span class="input-group-btn">
                       <button type="button" data-toggle="modal" data-target="#job" id="jobhide1" class="job btn btn-default btn-icon btn-xs"><i class="icon-search4"></i></button>
...
<div class="modal fade" id="tfcc" data-backdrop="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script>
   $(".tfcc").click(function(){
      $('#tfccc').html("<img src='<?php echo base_url(); ?>index.php/assets/images/loading.gif'> Loading...");
      $("#tfccc").load('<?php echo base_url(); ?>index.php/add_asset/transfer_retrive');
    });
</script>
...
<script>
  $(".job").click(function(){
       $('#jobb').html("<img src='<?php echo base_url(); ?>index.php/assets/images/loading.gif'> Loading...");
