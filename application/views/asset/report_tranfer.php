<div class="page-header">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i><span class="text-semibold">Home</span> - รายงานการโอนทรัพย์สิน</h4>
            </div>
      ...
      <div class="panel panel-flat">
           ...
           <table class="table table-xxs table-hover datatable-basicxc">
                ...
                <?php foreach ($pj as $key) { ?>
                    ...
                    <td><a href="<?php echo base_url(); ?>index.php/add_asset/report_asset_tfpj/<?php echo $key->project_code; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
                  </tr>
      ...
      <div class="panel panel-flat">
           ...
           <table class="table table-xxs table-hover datatable-basicxc">
                ...
                <?php foreach ($dm as $key1) { ?>
                    ...
                    <td><a href="<?php echo base_url(); ?>index.php/add_asset/report_asset_tfde/<?php echo $key1->department_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
                  </tr>
