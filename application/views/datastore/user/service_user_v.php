                      ...
                      <div class="row">
                        <div class="col-xs-6">
                          <div class="form-group">
                             <img src="<?php echo base_url();?>profile/<?php echo $val->uimg; ?>" class="img-responsive img-rounded thumbnail">
                          </div>
                        </div>
                        <div class="col-xs-6">
                          <div class="row">
                  ...
                  <div class="modal-dialog" role="document">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                <label for="">รหัสพนักงาน</label>
                                 <input type="text" class="form-control input-sm" placeholder="กรอกรหัสพนักงาน" id="ecode<?php echo $val->m_id;?>" value="<?php echo $val->m_code;?>">
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
