...
<div class="row">
   ...
   <div id="tabmatseven<?php echo $id; ?>" class="col-md-4">
       <h4>Unite</h4>
        ...
        <input type="hidden" id="tunitname<?php echo $id; ?>" name="">
     </div>
     <br>
  ...
  $("#btncostup<?php echo $id; ?>").click(function(){
    ...
    var dataSet={
      ...
      $.post(url,dataSet,function(data){
        ...
        $("#laborname<?php echo $id; ?>").val(data);
        $("#laborcode<?php echo $id; ?>").val(b1+b2+b3+b4+b5+b6+b7);
        $("#lo_matname<?php echo $id; ?>").val(data);
        $("#lo_matcode<?php echo $id; ?>").val(b1+b2+b3+b4+b5+b6+b7);


        $("#lmn<?php echo $id; ?>").val(data);
        $("#lmc<?php echo $id; ?>").val(b1+b2+b3+b4+b5+b6+b7);
        // $("#laborname<?php echo $id; ?>").val(data);
        // $("#laborcode<?php echo $id; ?>").val(b1+b2+b3+b4+b5+b6+b7);
