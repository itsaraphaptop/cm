<table class="table table-xxs table-hover datatable-basicxc34" >
<thead>
<tr>
<th>No.</th>
<th>Voucher</th>
...
<td><a class="opendeptoriv<?php echo $n;?> btn btn-xs btn-block btn-primary" data-dismiss="modal">SELECT</a></td>
</tr>

<script>
 $(".opendeptoriv<?php echo $n;?>").click(function(event) {
  $('#vchno').val("");
  $('#vchdate').val("");
  $('#glyear').val("");
  $('#glperiod').val("");
  ...
  $("#table").load('<?php echo base_url(); ?>index.php/share/modal_list_gl/<?php echo $val->vchno; ?>');
 });
</script>
<?php $n++; } ?>
</tbody>
