...
<!-- <div class="col-md-4">
  <ul class="icons-list">
    <li><button type="button" data-toggle="modal" data-target="#newmatone" class="newmatone label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม TYPE</button></li>
    <li><button type="button" data-toggle="modal" data-target="#editmatone" class="newmatone label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข TYPE</button></li>
    <li><button type="button" id="dmattype" class="newmatone label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ TYPE</button></li>
  </ul>
</div> -->
...
<!-- <div class="col-md-4">
  <ul class="icons-list">
    <li><button type="button" data-toggle="modal" data-target="#newmattwo" class="newmattwo label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม GROUP</button></li>
    <li><button type="button" data-toggle="modal" data-target="#emattwo" class="newmattwo label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข GROUP</button></li></li>
    <li><button type="button" id="dmattwo" class="newmattwo label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ GROUP</button></li>
  </ul>
</div>
<div class="col-md-4">
  <div class="icons-list">
    <li><button type="button" data-toggle="modal" data-target="#newmattree" class="newmattree label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม SUB GROUP</button></li>
    <li><button type="button" data-toggle="modal" data-target="#emattree" class="newmattree label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข SUB GROUP</button></li>
    <li><button type="button" id="dmattree" class="newmattree label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ SUB GROUP</button></li>
  </div>
</div> -->
...
<!-- <div class="row">
  <div class="col-md-4">
  <div class="icons-list">
    <li><button type="button" data-toggle="modal" data-target="#newmatfor" class="newmatfor label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม P/M</button></li>
    <li><button type="button" data-toggle="modal" data-target="#ematfor" class="newmatfor label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข P/M</button></li>
    <li><button type="button" id="dmatfor" class="newmatfor label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ P/M</button></li>
  </div>
  </div>
  <div class="col-md-4">
    <div class="icons-list">
      <li><button type="button" data-toggle="modal" data-target="#newmatfive" class="newmatfive label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม Spec</button></li>
      <li><button type="button" data-toggle="modal" data-target="#ematfive" class="newmatfive label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข Spec</button></li>
      <li><button type="button" id="dmatfive" class="newmatfive label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ Spec</button></li>
    </div>
  </div>
  <div class="col-md-4">
    <div class="icons-list">
      <li><button type="button" data-toggle="modal" data-target="#newmatsix" class="newmatsix label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม Brand</button></li>
      <li><button type="button" data-toggle="modal" data-target="#ematsix" class="newmatsix label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข Brand</button></li>
      <li><button type="button" id="dmatsix" class="newmatsix label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ Brand</button></li>
    </div>
  </div>
</div>
 -->
...
<div class="col-md-4">
    <!-- <div class="icons-list">
      <li><button type="button" data-toggle="modal" data-target="#newmatseven" class="newmatseven label label-primary label-sm" style="display: block;"><i class="icon-plus-circle2"></i> เพิ่ม Unit</button></li>
      <li><button type="button" data-toggle="modal" data-target="#ematseven" class="newmatseven label label-info label-sm" style="display: block;"><i class="icon-pencil7"></i> แก้ไข Unit</button></li>
      <li><button type="button" id="dmatseven" class="newmatseven label label-danger label-sm" style="display: block;"><i class="icon-trash"></i> ลบ Unit</button></li>
    </div> -->
  </div>
...
<div class="row">
   <div id="tabmatseven" class="col-md-4">
     ...
     <br>
     <div class="row">
              <button class="btn btn-primary btn-block"  data-dismiss="modal" id="btncostup">เลือก</button>
        </div>
     <div class="row">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">เพิ่มหมวด Meterial </h4>
      </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="text-right">
                    <a id="savetype" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
            </div>
        </div>
 ...
 <div class="modal fade" id="editmatone" >
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">แก้ไขหมวด Meterial </h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
            <div class="row">
            ...
            <div class="row">
                <div class="text-right">
                    <a id="esavetype" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
            </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="mattypecode">
                    <button id="savegroup" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
            </div>
        </div>
 ...
 <div class="modal fade" id="emattwo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">แก้ไขชือวัสดุ</h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="emattypecode">
                    <button id="esavegroup" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
            </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="matgroupcodetree">
                    <button id="savesubgroup" data-dismiss="modal" class="btn  bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
            </div>
        </div>
 ...
 <div class="modal fade" id="emattree" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content  bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">แก้ไขขนาดวัสดุ</h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="ematgroupcodetree">
                    <button id="esavesubgroup" data-dismiss="modal" class="btn  bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
            </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="matsubgroupcodefor">
                    <button id="saveunit" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
        </div>
        </div>
 ...
 <div class="modal fade" id="ematfor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">แก้ไข Product / Material</h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="ematsubgroupcodefor">
                    <button id="esaveunit" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</button>
                </div>
            </div>
        </div>
        </div>
 ...
 <div class="modal fade" id="newmatfive" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">เพิ่ม SPEC</h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="matproductcodefive">
                    <a id="savespec" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
        </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="matspeccodesix">
                    <a id="savebrand" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <input type="hidden" id="matunitnameu">
                    <a id="saveunitname" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                    <script>
 ...
 <div class="modal fade" id="ematfive" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content bg-teal-300">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">แก้ไข SPEC</h4>
      </div>
        <div class="modal-body">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="ematproductcodefive">
                    <a id="esavespec" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
        </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" id="ematspeccodesix">
                    <a id="esavebrand" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="input-group-btn">
                <button type="button" class="unitv btn btn-default btn-icon" data-toggle="modal" data-target="#unitsel2"><i class="icon-search4"></i></button>
                </div>
              </div>
            </div>
            <div class="col-md-8">
            ...
            <div class="row">
                ...
                <input type="hidden" id="ematunitidue" >
                    <a id="esaveunitname" data-dismiss="modal" class="btn bg-teal-600">ยืนยันการเพิ่มข้อมูล</a>
                    <script>
...
var url="<?php echo base_url(); ?>materialcode/getproductgroup_where";
  var dataSet={
      name : $('#sgroupp').val()
    };
  $.post(url,dataSet,function(data){
