...
// $("#taxv").val('0');
    ...
    var dataSet={
     ...
     $('#codenamecost').val(`${codecostcode} ${gcostcode}`);
     $('#costname_edit').val(gcostcode);
     $('#codecostcode_edit').val(codecostcode);
     $('#codecostcodei').val(codecostcode);
     $('#costnamei').val(gcostcode);

     $('#exac_costcode').val(codecostcode);
     $('#exac_costname').val(gcostcode);

     $('#codecostcodei<?php echo $id; ?>').val(codecostcode);
     $('#costnamei<?php echo $id; ?>').val(gcostcode);
     $('#costcodetext<?=$id?>').val(codecostcode);

     $("#codecostcodeint<?php echo $id; ?>").val(codecostcode);
     $("#costnameint<?php echo $id; ?>").val(gcostcode);

     $('#costname<?php echo $id; ?>').val(gcostcode);
     $('#costcodei<?php echo $id; ?>').val(codecostcode);
