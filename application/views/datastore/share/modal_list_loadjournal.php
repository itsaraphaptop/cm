	...
	<div class="table-responsive">
		<table class="table table-bordered">
			...
			<tbody id="bodygl">
				...
				<tr>
					<td><?php echo $n; ?><input type="hidden" value="Y" id="chki<?php echo $n; ?>" name="chki[]"><input type="hidden" value="" id="chkitype" name="chkitype[]"><input type="hidden" value="" id="ref" name="ref[]"><input type="hidden" value="<?php echo $key->vchid; ?>" id="vchid" name="vchid[]"></td>
					<td>
						<div class="input-group">
						
						<input _ice_ type="text" readonly="true" value="<?php echo $key->ac_code; ?>" class="form-control input-sm" name="acc_code[]" id="acc_code<?php echo $n; ?>">
						<input type="text" style="width: 200px;" name="acc_name[]"  class="form-control" readonly="readonly" placeholder="Account Name" value="<?php echo $key->ac_name; ?>">
				...
				<td>
					<div class="form-group">
						<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Project Name " value="<?php echo $key->project_name; ?>" name="pro_name[]" id="pro_name<?php echo $n; ?>">
						<input type="hidden" _ice_ readonly="true" value="<?php echo $key->project_id; ?>" class="form-control input-sm" name="pro_code[]" id="pro_code<?php echo $n; ?>">
						<!-- <div class="input-group-btn">
				...
				<td>
					<div class="form-group">
						<input type="text" style="width: 150px;"  class="form-control" readonly="readonly" placeholder="System Name " value="<?php echo $key->systemname; ?>" name="sys_name[]" id="sys_name<?php echo $n; ?>">
						<input type="hidden" _ice_ readonly="true" value="<?php echo $key->jobcode; ?>" class="form-control input-sm" name="sys_code[]" id="sys_code<?php echo $n; ?>">
						<!-- <div class="input-group-btn">
			...
			<td>
				<div class="input-group" id="origin">
					<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Code" name="costcode[]" id="costcodetexti<?php echo $n; ?>" value="<?php echo $key->costcode; ?>">
					<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Name" name="costname[]" id="costnamei<?php echo $n; ?>" value="<?php echo $key->costname; ?>">
					...
					<td><input type="text" style="width: 100px;" value="<?php echo $key->amtcr; ?>"  class="dr form-control text-right" value="" name="dr[]" id="dr" ac="#cr"></td>
					<td><input type="text" style="width: 100px;" value="<?php echo $key->amtdr; ?>" class="cr form-control text-right" value="" name="cr[]" id="cr" ac="#dr"></td>
					<td>
						...
						<td>
							...
							<td><input type="text" style="width: 100px;"  class="form-control text-right" value="<?php echo $key->amtdr+$key->amtcr; ?>" name="amt[]" id="amt"></td>
							...
							<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Vender Name" value="<?php echo $key->namevendor; ?>" name="ven_name[]" id="ven_name">
							<input type="hidden" readonly="true" value="<?php echo $key->varchar; ?>" class="form-control input-sm" name="ven_code[]" id="ven_code">
							<div class="input-group-btn">
							...
							<td><div class="input-group">
								<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Customer" value="<?php echo $key->namecus; ?>" name="cus_name[]" id="cus_name">
								<input type="hidden" readonly="true" value="<?php echo $key->cust_code; ?>" class="form-control input-sm" name="cus_code[]" id="cus_code">
								<div class="input-group-btn">
							...
							<td><select class="form-control"  id="tax" attr-id="" style="width: 100px;">
								...
								<option class="1">W/T(Paid)</option>
								<option class="2">VAT(Buy)</option>
								<option class="3">W/T(Revenue)</option>
								<option class="4">VAT(Sale)</option>
							</select>
							...
							<td><select class="form-control" name="taxdesc[]" readonly="true" id="taxdes" style="width: 120px;">
								...
								<option class="2">ค่าบริการ</option>
								<option class="3">ค่าขนส่ง</option>
								<option class="4">ค่าเช่า</option>
								<option class="5">ค่าโฆษณา</option>
							</select></td>
