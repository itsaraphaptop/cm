		...
		<table class="table table-bordered">
			...
			<td>
				<div class="input-group" id="origin">
					<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Code" name="costcode[]" id="costcodetext<?php echo $n; ?>" value="<?php echo $key->costcode; ?>">
					...
					<span class="input-group-btn" >
						<a class="costmat<?php echo $n; ?> btn btn-info btn-sm " data-target="#costcode<?php echo $n; ?>"><span class="glyphicon glyphicon-search"></span></a>
					</span>
