		...
		<table class="table table-bordered">
			...
			<tbody id="bodygl">
				<?php $n=1; $de_periond=0; foreach ($res as $key) {
					$de_periond = $de_periond+$key->de_periond;
				?>
				<tr>
					...
					<td>
						<div class="input-group">
							...
							<input _ice_ type="text" readonly="true" value="<?php  if($key->project_department=="1"){ echo $key->at_costid; }else if($key->project_department=="2"){ echo $key->at_acdid; } ?>" class="form-control input-sm" name="acc_code[]" id="acc_code<?php echo $n; ?>">
							<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Account Name" value="<?php if($key->project_department=="1"){ echo $key->at_cost; }else if($key->project_department=="2"){ echo $key->at_acd; } ?>" name="acc_name[]" id="act_name<?php echo $n; ?>">
					...
					<td>
						<div class="form-group">
							<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Project Name " value="<?php echo $key->de_pjname; ?>" name="pro_name[]" id="pro_name<?php echo $n; ?>">
							<input type="hidden" _ice_ readonly="true" value="<?php echo $key->de_pjid; ?>" class="form-control input-sm" name="pro_code[]" id="pro_code<?php echo $n; ?>">
							<!-- <div class="input-group-btn">
					...
					<?php $a = $this->db->query("select * from system where systemcode = '$key->de_job'")->result();
						foreach ($a as $sy) {
					...
					<td>
						<div class="form-group">
							...
							<input type="hidden" _ice_ readonly="true" value="<?php echo $key->de_job; ?>" class="form-control input-sm" name="sys_code[]" id="sys_code<?php echo $n; ?>">
							<!-- <div class="input-group-btn">
					...
					<td>
						<div class="input-group" id="origin">
							<input type="text" name="costcode[]" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Name" value="<?php  if($key->project_department=="1"){ echo $key->at_idcost; }else if($key->project_department=="2"){ echo ""; } ?>"  id="cccost<?php echo $n; ?>">
							<input type="text" name="costname[]" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Code" value="<?php  if($key->project_department=="1"){ echo $key->at_namecost; }else if($key->project_department=="2"){ echo ""; } ?>"  id="ccname<?php echo $n; ?>">
							...
							<td><input type="text" style="width: 100px;" value="<?php echo $key->de_periond; ?>"  class="dr form-control text-right" value="" name="dr[]" id="dr" ac="#cr"></td>
							<td><input type="text" style="width: 100px;" value="0" class="cr form-control text-right" value="" name="cr[]" id="cr" ac="#dr"></td>
							<td>
								...
								<td>
									...
									<td><input type="text" style="width: 100px;"  class="form-control" value="<?php echo $key->de_periond; ?>" name="amt[]" id="amt"></td>
									...
									<td><div class="input-group">
										<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Vender Name" value="<?php echo $key->fa_vendername; ?>" name="ven_name[]" id="ven_name">
										<input type="hidden" readonly="true" value="<?php echo $key->fa_vender; ?>" class="form-control input-sm" name="ven_code[]" id="ven_code">
										<div class="input-group-btn">
									...
									<td><div class="input-group">
										<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Customer" value="<?php echo $key->fa_lisename; ?>" name="cus_name[]" id="cus_name">
										<input type="hidden" readonly="true" value="<?php echo $key->fa_liseid; ?>" class="form-control input-sm" name="cus_code[]" id="cus_code">
										<div class="input-group-btn">
								...
								<tr>
									<td><input type="hidden" value="Y" id="chki" name="chki[]"><input type="hidden" value="" id="chkitype" name="chkitype[]"><input type="hidden" value="" id="ref" name="ref[]"></td>
									<td><div class="input-group">
										<input _ice_ type="text" readonly="true" value="<?php echo $key->at_acaccid; ?>" class="form-control input-sm" name="acc_code[]" id="acc_codes<?php echo $n; ?>">
										<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Account Name" value="<?php echo $key->at_acacc; ?>" name="acc_name[]" id="act_names<?php echo $n; ?>">
										
										<div class="input-group-btn">
											<button type="button" data-toggle="modal" data-target="#openaccs<?php echo $n; ?>" row="" onclick="openacc($(this))"  class="openaccs<?php echo $n; ?> btn btn-default btn-icon"><i class="icon-search4"></i></button>
										</div>
									</div>
								</td>
								<td>
									<div class="form-group">
										<input type="hidden" _ice_ readonly="true" value="<?php echo $key->de_pjid; ?>" class="form-control input-sm" name="pro_code[]" id="pro_code">
										<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Project Name " value="<?php echo $key->de_pjname; ?>" name="pro_name[]" id="pro_name">
									...
									<td><div class="form-group">
										<input type="text" style="width: 150px;"  class="form-control" readonly="readonly" placeholder="System Name " value="<?php echo $systemname; ?>" name="sys_name[]" id="sys_name">
										<input type="hidden" _ice_ readonly="true" value="<?php echo $key->de_job; ?>" class="form-control input-sm" name="sys_code[]" id="sys_code">
										<!-- 	<div class="input-group-btn">
												<button type="button" data-toggle="modal" data-target="#opensys"  class="opensys btn btn-default btn-icon"><i class="icon-search4"></i></button>
										</div> -->
									</div>
								...
								<td><div class="input-group" id="origin">
									<input type="text" name="costcode[]" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Name"   id="cccosti<?php echo $n; ?>">
									<input type="text" name="costname[]" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Code"   id="ccnamei<?php echo $n; ?>">
									<span class="input-group-btn" >
										<a class="costmati<?php echo $n; ?> btn btn-info btn-sm " data-toggle="modal" id="btncost" attr-id= data-toggle="modal" data-target="#costcodei<?php echo $n; ?>"><span class="glyphicon glyphicon-search"></span></a>
									</span>
									<div id="Costcode"></div></td>
									<td class="text-center"><div id="Budget" >-</div>
									<input value="" type="hidden" id="total_bal" name=total_bal[] type="text" />
									<input value="" type="hidden" id="boq_id" name=boq_id[] type="text" />
									<input value="" type="hidden" id="bd_tender"  name=bd_tenid[] type="text" /></td>
									<td><input type="text" style="width: 100px;" value="0"  class="dr form-control text-right" value="" name="dr[]" id="dr" ac="#cr"></td>
									<td><input type="text" style="width: 100px;" value="<?php echo $key->de_periond; ?>" class="cr form-control text-right" value="" name="cr[]" id="cr" ac="#dr"></td>
									<td><select class="form-control" name="paid[]" id="paid" style="width: 150px;">
										<option class="1">Bank(Chq.)</option>
										<option class="2">Cash</option>
									</select></td>
									<td><input type="text" style="width: 250px;"  class="form-control" value="" name="description[]" id="description"></td>
									<td><input type="text" style="width: 100px;"  class="form-control" value="" name="refno[]" id="refno"></td>
									<td><input type="date" style="width: 150px;"  class="form-control" value="<?php echo date("Y-m-d"); ?>" name="refdates[]" id="refdate"></td>
									<td><input type="text" style="width: 100px;"  class="form-control" value="<?php echo $key->de_periond; ?>" name="amt[]" id="amt"></td>
									<td><input type="text" style="width: 50px;"  class="form-control" value="" name="vat[]" id="vat"></td>
									...
									<td><div class="input-group">
										<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Vender Name " value="<?php echo $key->fa_vendername; ?>" name="ven_name[]" id="ven_name">
										<input type="hidden" readonly="true" class="form-control input-sm" name="ven_code[]" id="ven_code" value="<?php echo $key->fa_vender; ?>">
										<div class="input-group-btn">
											<!-- <button type="button" data-toggle="modal" data-target="#openven"  class="openven btn btn-default btn-icon"><i class="icon-search4"></i></button> -->
										</div>
									</div></td>
								...
								$("#modal_cost<?php echo $n; ?>").load('<?php echo base_url();?>share/costcode_id/<?php echo $n; ?>/1');
								});
								
								</script>
								<div class="modal fade" id="costcodei<?php echo $n; ?>" data-backdrop="false">
									<div class='modal-dialog modal-full'>
										<div class='modal-content'>
											<div class='modal-header'>
												<button type='button' class='close' data-dismiss='modal'>&times;</button>
								...
								$('.costmati<?php echo $n; ?>').click(function(){
								$('#modal_costi<?php echo $n; ?>').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
								$("#modal_costi<?php echo $n; ?>").load('<?php echo base_url();?>share/costcode_id/<?php echo $n; ?>/2');
								});
