		...
		<table class="table table-bordered">
			...
			<td>
				<div class="input-group" id="origin">
					<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Code" name="costcode[]" id="codecostcode<?php echo $n; ?>" value="<?php echo $key->costcode; ?>">
					<input type="text" style="width: 200px;"  class="form-control" readonly="readonly" placeholder="Cost Name" name="costname[]" id="costname<?php echo $n; ?>" value="<?php echo $key->costname; ?>">
					...
					<td><input type="text" style="width: 100px;" value="<?php echo $key->amtdr; ?>"  class="dr form-control text-right" value="" name="dr[]" id="dr" ac="#cr"></td>
					<td><input type="text" style="width: 100px;" value="<?php echo $key->amtcr; ?>" class="cr form-control text-right" value="" name="cr[]" id="cr" ac="#dr"></td>
					<td>
