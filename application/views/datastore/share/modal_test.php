<div class="row">
    ...
    <div id="cost-control<?php echo $n;?>" class="col-xs-12">
        <hr>
            ...
            <button class="btn btn-primary" style="float:right;" data-dismiss="modal" id="btncostup<?php echo $n;?>" onclick="render_mat<?php echo $n;?>">SELECT</button>
            </div>
        </div>
    </div>
...
// $("#taxv<?php echo $n;?>").val('0');
    ...
    $( "#cost3<?php echo $n;?>").change(function() {
        ...
        var c3 = $('#cost3<?php echo $n;?>').val();
         ...
         $("#costcodename<?php echo $n;?>").val(c3);
    ...
    var dataSet={
     ...
     $("#code_type_1_<?php echo $n; ?>").val(c1);
     ...
     $("#codecostname<?php echo $pr_id; ?>").val(gcostcode);
     $("#costname<?php echo $n;?>").val(gcostcode);
     $("#codecostcode<?php echo $n; ?>").val(codecostcode);
     $("#codecostname<?php echo $n; ?>").val(gcostcode);

     $('#lo_costname<?php echo $n; ?>').val(gcostcode);
     $('#lo_costcode<?php echo $n; ?>').val(codecostcode);

     var subcostcode = codecostcode.substring(0,1)
     
     if(subcostcode!="G"){
             $('#gbboq<?php echo $n; ?>').val(codecostcode.substring(1,10));
         }else{
             $('#gbboq<?php echo $n; ?>').val(codecostcode.substring(0,10));
         }
