...
<td><button class="openvensmo btn btn-xs btn-block btn-primary" data-toggle="modal"  data-vnameh="<?php echo $val->vender_name;?>" data-addrh="<?php echo $val->vender_address; ?>" data-crteam="<?php echo $val->vender_credit;?>" data-vtel="<?php echo $val->vender_tel; ?>" data-code="<?php echo $val->vender_code; ?>" data-id="<?php echo $val->vender_id; ?>"
...
<script>
  $(".openvensmo").click(function(event) {
    ...
    $("#vendercode<?php echo $id; ?>").val($(this).data('code'));
    $("#venname<?php echo $id; ?>").val($(this).data('vnameh'));

    $("#vencode<?php echo $id; ?>").val($(this).data('code'));
  });
</script>
