...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <!--begin::Subheader-->
    <form class="form" action="<?php echo base_url(); ?>datastore_active/add_employee" method="post" enctype="multipart/form-data" id="kt_Employee">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="btn-group ml-2">
                        <button type="submit" class="btn btn-primary font-weight-bold save-change" id="submitButton">Submit</button>
                    </div>
                    <!--end::Dropdown-->
                </div>
                <!--end::Toolbar-->
                        ...
                        <div class="tab-content pt-5">
                            ...
                            <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <div class="image-input image-input-outline" id="kt_contacts_edit_avatar" style="background-image: url(<?php echo base_url();?>boostrap4/dist/assets/media/users/blank.png)">
                                            <div class="image-input-wrapper" style="background-image: url(<?php echo base_url();?>boostrap4/dist/assets/media/users/blank.png)"></div>
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" name="ccode" readonly type="text"/>
                                    </div>
                                </div> -->
                                <input type="hidden" name="cid" id="cid" class="form-control" value="">
                                <input type="hidden" name="flag" id="flag" class="form-control" value="ins">
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Employee Name</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg" type="text" name="cname"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Email Address</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg" type="text" name="cmail"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Contact Phone</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input id="kt_inputmask_3" class="form-control form-control-lg" type="text" name="ctel"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-lg  form-control-solid" readonly="readonly" id="projid" name="project1" placeholder="" value="">
                                            <input type="text" class="form-control form-control-lg  form-control-solid" readonly="readonly" id="projname" name="projname" value="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <?php foreach ($getposition as $val) { ?>
                                            <option value="<?php echo $val->id; ?>"><?php echo $val->p_name; ?></option>
                                        <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <select class="form-control form-control-lg" name="mdash" id="mdash">
                                            ...
                                            <option value="2" selected>GM</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="kt_apps_projects_view_tab_3" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" name="cuser" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6 ">
                                    <div class="input-icon input-icon-right">
                                        <input class="form-control form-control-lg" name="cpass" id="password" type="password"/>
                                        <span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg" name="lineid" type="text"/>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    //                 $.ajax({
    //                     url: '<?php echo base_url(); ?>datastore_active/add_employee',
    //                     type: 'POST',
    //                     data: formData,
    //                     async: false,
    //                     cache: false,
    ...
    //                             )
    //                             setTimeout(function() {
    //                                 window.location.href = "<?php echo base_url(); ?>datastore/editemployee/"+json.m_id+"/"+json.m_code;
    //                             }, 500);
    //                         }else{
    //                             Swal.fire(
    //                                 json.message,
...
<!--end::Modal-->
<script src="<?php echo base_url();?>validation/employee.js"></script>
