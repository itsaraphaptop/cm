              ...
              <table class="table table-hover table-bordered table-xxs">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>index.php/inventory/receive_po_list/<?php echo $value->project_code; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
