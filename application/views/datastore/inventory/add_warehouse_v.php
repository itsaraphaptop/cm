...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>setup_wh/savewh_nv" id="formcom">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="code" readonly class="form-control form-control form-control-solid">
                                            <input type="hidden"  name="maincode" value="<?php echo $compcode; ?>" >
                                            <input type="hidden"  name="projectid" value="<?php echo $module_id; ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Name</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="whname" name="whname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
