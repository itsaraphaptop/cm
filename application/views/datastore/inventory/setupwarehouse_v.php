                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <a href="<?php echo base_url();?>datastore/addwarehouse/<?php echo $module_id?>" class="btn btn-primary font-weight-bolder">
...
<script>var HOST_URL = "<?php echo base_url();?>jsonr/getwhdata/<?php echo $module_id?>";</script>
			...
			columns: [
				{
					...
					template: function(row) {
						return '\
							<a href="<?php echo base_url();?>datastore/editwarehouse/'+row.id+'/'+row.whcode+'" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
