...
<div class="row" style="margin-top:10px;">
    ...
    <div class="col-xs-9" id="loaduser">
            ...
            <div class="col-xs-6">
                ...
                <label for="">ประเภท</label>
                     ...
                     <?php if($val->m_status == 'md'){ ?><option value="md" selected>ผู้บริหาร</option><?php } else { ?><option value="md">ผู้บริหาร</option><?php }?>
                        ...
                        <?php if($ctype == 'o'){ ?><option value="o" selected>Offce</option><?php } else { ?><option value="o">Office</option><?php }?>
                        <?php if($ctype == 's'){ ?><option value="s" selected>Site</option><?php } else { ?><option value="s">Site</option><?php }?>
                    </select>
                </div>
            </div>
            <div class="col-xs-6">
