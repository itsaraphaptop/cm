...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore/add_costtype_nv" id="formcom">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            <input type="text"  name="maincode" value="<?php echo $compcode; ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Name</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="type_name" name="type_name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-lg form-control-solid" readonly="readonly" id="accno" name="accno">
                                                <input type="text" class="form-control form-control-lg form-control-solid" readonly="readonly" id="accountname" name="accountname">
