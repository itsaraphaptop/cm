...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/edit_system_nv" id="formcom">
	<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="<?php echo base_url();?>datastore/setprojectjob" class="btn btn-default font-weight-bold">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                                    <li class="nav-item mr-3">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                            ...
                                            <span class="nav-text font-weight-bold">Project Job Details</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">System Code</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="systemcodee" readonly="readonly" value="<?php echo $res[0]['systemcode']; ?>" class="form-control input-sm">
                                            <input type="hidden"  name="maincode" value="<?php echo $compcode; ?>" >
                                            <input type="hidden" name="id" value="<?php echo $module_id; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">System Name</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="systemnamee" name="systemnamee" value="<?php echo $res[0]['systemname']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" <?= ($res[0]['sys_active'] == 1) ? "selected='sleected'" : "";?> >Active</option>
                                            <option value="2" <?= ($res[0]['sys_active'] == 2) ? "selected='selected'" : "";?> >Inactive</option>
                                        </select>
