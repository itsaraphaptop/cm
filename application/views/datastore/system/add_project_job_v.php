...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/add_project_job" id="formcom">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="systemcode" class="form-control input-sm">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">System Name</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="systemname" name="systemname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
