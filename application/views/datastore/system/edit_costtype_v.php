...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore/edit_costtype_nv" id="formcom">
	<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="<?php echo base_url();?>datastore/cost_type" class="btn btn-default font-weight-bold">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                                    <li class="nav-item mr-3">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                            ...
                                            <span class="nav-text font-weight-bold">Cost Type Details</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Code</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="code" readonly="readonly" value="<?php echo $res[0]['costtype_code']; ?>" class="form-control input-sm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="type_name" name="type_name" value="<?php echo $res[0]['costype_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">A/C Contruction</label>
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-lg form-control-solid" readonly="readonly" id="accno" name="accno" placeholder="" value="<?=$res[0]['acc_code1']?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="Y" <?= ($res[0]['costtype_status'] == 'Y') ? "selected='sleected'" : "";?> >Active</option>
                                            <option value="N" <?= ($res[0]['costtype_status'] == 'N') ? "selected='selected'" : "";?> >Inactive</option>
                                        </select>
...
$(".acprimary").on("click",function(){
    ...
    $('#acprimaryload').load('<?php echo base_url();?>share/load_modal_account_detail');
});
</script>