...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/newunit_nv" id="formcom">
                            ...
                            <div class="tab-content pt-5">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="uomname" name="uomname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
