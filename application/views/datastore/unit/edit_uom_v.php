...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/editunit_nv/<?=$module_id;?>" id="formcom">
	<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <h5 class="text-dark-50 font-weight-bold mt-2 mb-2 mr-5">Setup Unit of measure</h5>
                    <!--end::Page Title-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="<?php echo base_url();?>datastore/setupunit" class="btn btn-default font-weight-bold">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                                    <li class="nav-item mr-3">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                            ...
                                            <span class="nav-text font-weight-bold">Unit of measure Details</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="code" readonly="readonly" value="<?php echo $res[0]['unit_code']; ?>" class="form-control input-sm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="uomname" name="uomname" value="<?php echo $res[0]['unit_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="yes" <?= ($res[0]['status'] == 'yes') ? "selected='sleected'" : "";?> >Active</option>
                                            <option value="no" <?= ($res[0]['status'] == 'no') ? "selected='selected'" : "";?> >Inactive</option>
                                        </select>
