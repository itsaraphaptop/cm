...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore/edit_business_active" id="formcom">
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="business_code" readonly="readonly" value="<?php echo $res[0]['business_code']; ?>" class="form-control input-sm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="business_name" name="business_name" value="<?php echo $res[0]['business_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" <?= ($res[0]['status'] == 1) ? "selected='sleected'" : "";?> >Active</option>
                                            <option value="2" <?= ($res[0]['status'] == 2) ? "selected='selected'" : "";?> >Inactive</option>
                                        </select>
