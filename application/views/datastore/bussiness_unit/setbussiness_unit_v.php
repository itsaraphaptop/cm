                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Business Unit
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <a href="<?php echo base_url();?>datastore/add_new_business" class="btn btn-primary font-weight-bolder">
...
<script>var HOST_URL = "<?php echo base_url();?>jsonr/getbusiness_unit";</script>
			...
			columns: [
				{
					...
					template: function(row) {
						return '\
							<a href="<?php echo base_url();?>datastore/edit_business/'+row.business_id+'" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
