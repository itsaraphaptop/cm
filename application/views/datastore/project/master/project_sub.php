...
<div class="content">
	<div class="panel panel-white">
        ...
        <i class="icon-cog3 position-left"></i>
				<b>Setup Sub Project : </b>
				<b style="color: red;">
					<?php echo $projname; ?>
</b>
</h5>
</div>
<form class="stepy-clickable form-horizontal" id="formdata" method="post" action="<?php echo base_url(); ?>datastore/addsubproject/<?php echo $projid; ?>">
				...
				<div class="tab-pane active" id="bottom-tab1">
						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									<div class="col-sm-10">
										<img src="<?php echo base_url();?>assets/images/module/icon_company.png" id="imgcomp"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label class="radio-inline">
											<input type="radio" name="radioprode" class="styled" checked="checked" value="1"> Project
										</label>
										<label class="radio-inline">
											<input type="radio" name="radioprode" class="styled" value="2"> Department
										</label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="projno" id="projno" placeholder="Project Code" class="form-control input-sm" type="text" value="<?=$sub_proid;?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Project/Dep. Name :</label>
									<div class="col-sm-8">
										<input name="projname" id="projname" placeholder="Project Name" class="form-control input-sm" required="" type="text">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-10">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="address" rows="3" class="form-control input-sm" cols="40" placeholder="Plase input Project Address"></textarea>
									</div>
								</div>
								<!-- <div class="form-group">
									<label class="col-sm-4 control-label" for="typejob">Job System</label>
									<div class="col-sm-8">
										<select class="form-control input-sm" name="typejob" id="typejob">
											<option value=""></option>
											<?php
                                  foreach ($getdesc as $des) { ?>
								<option value="<?php echo $des->job_code; ?>">
									<?php echo $des->job_name; ?>
								</option>
								<?php } ?>
								</select>
							</div>
						...
						<!-- <div class="row">
									<div class="col-md-3">
										<div class="form-group">
											...
											<input name="phonenumber" placeholder="เบอร์โทร" class="form-control input-sm" type="text">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="fax">FAX</label>
											<input name="fax" placeholder="แฟกซ์" class="form-control input-sm" type="text">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="email">E-mail</label>
											<input name="email" placeholder="อีเมล" class="form-control input-sm" type="text">
										</div>
									</div>
                </div> -->
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="project_wt" id="wt" placeholder="W/T(%)" class="form-control input-sm" type="text">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Vat(%) :</label>
							<div class="col-sm-8">
								<input name="project_vat" id="vat" placeholder="Vat(%)" class="form-control input-sm" type="text">
							</div>
						</div>
						<div class="form-group">
					...
					<div class="col-sm-5 col-sm-offset-1">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="insurcontract" placeholder="กรอกระยะเวลาสัญญา" class="form-control input-sm" type="text">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="date" class="form-control input-sm" id="startproject" name="startproject">
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="date" class="form-control input-sm" id="endtproject" name="endtproject">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" id="accno" class="form-control input-sm" readonly="" name="accno">
							</div>
							<div class="col-sm-4">
								<div class="input-group">
									<input name="accountname" id="accountname" required class="form-control input-sm" type="text" readonly="">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<input type="text" id="acc_no" class="form-control input-sm" readonly="" name="acc_no">
							</div>
							<div class="col-md-4">
								<div class="input-group">
									<input name="acc_name" id="acc_name" required class="form-control input-sm" type="text" readonly="">
									<div class="input-group-btn">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="input-group">
									<input name="projectadvance_1" placeholder="" class="form-control input-sm" type="text" value="0.00" style="text-align: right;">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="input-group">
									<input name="projectlessretention " placeholder=" " class="form-control input-sm
					 " type="text " value="0.00 " style="text-align: right; ">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="input-group">
									<input name="projectlessadvance" placeholder="" class="form-control input-sm" type="text" value="0.00" style="text-align: right;">
									<span class="input-group-addon bg-primary"> % </span>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<div class="col-sm-3">
								<a class="btn btn-default btn-icon btn-xs">
									GL for IC &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" class="styled" id="" name="chkgl" value="1">
								</a>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-3">
								<a class="btn btn-default btn-icon btn-xs">
									Control BOQ &nbsp;
									<input type="checkbox" class="styled" id="chkconbqq" name="chkconbqq" value="1">
								</a>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select type="text" class="form-control input-sm" id="controlbg" name="controlbg">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="projectval" id="projectval" placeholder="กรอกมูลค่าโครงการ" class="form-control input-sm" type="text">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="ownername_th" id="ownername_th" placeholder="กรอกชื่อภาษาไทย" class="form-control input-sm" type="text">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Owner Name (EN) :</label>
							<div class="col-sm-6">
								<input name="ownername_en" id="ownername_en" placeholder="กรอกชื่อภาษาอังกฤษ" class="form-control input-sm" type="text">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Address :</label>
							<div class="col-sm-6">
								<textarea class="form-control input-sm" name="owner_address" id="owner_address" rows="4" cols="40" placeholder="กรอกชื่อที่อยู่"></textarea>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="owner_phonenumber" id="owner_phonenumber" placeholder="เบอร์โทร" class="form-control input-sm" type="tel">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">FAX :</label>
							<div class="col-sm-6">
								<input name="owner_fax" id="owner_fax" placeholder="แฟกซ์" class="form-control input-sm" type="tel">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">E-Mail :</label>
							<div class="col-sm-6">
								<input name="owner_email" id="owner_email" placeholder="อีเมล" class="form-control input-sm" type="text">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="tab-pane" id="bottom-tab6">
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="contractor_name_th" placeholder="กรอกชื่อภาษาไทย" class="form-control input-sm" type="text" value="<?= $add_data->company_name ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">SubContactor Name (EN) :</label>
							<div class="col-sm-6">
								<input name="contractor_name_en" placeholder="กรอกชื่อภาษาอังกฤษ" class="form-control input-sm" type="text" value="<?= $add_data->company_name ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Address :</label>
							<div class="col-sm-6">
								<textarea class="form-control input-sm" name="contractor_address" rows="4" cols="40" placeholder="กรอกชื่อที่อยู่"><?= $add_data->company_add_en ?></textarea>
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-sm-4 control-label">Telephone :</label>
							<div class="col-sm-6">
								<input name="contractor_phonenumber" placeholder="เบอร์โทร" class="form-control input-sm" type="tel" value="<?= $add_data->company_tel ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">FAX :</label>
							<div class="col-sm-6">
								<input name="contractor_fax" placeholder="แฟกซ์" class="form-control input-sm" type="tel" value="<?= $add_data->company_fax ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">E-Mail :</label>
							<div class="col-sm-6">
								<input name="contractor_email" placeholder="อีเมล" class="form-control input-sm" type="text" value="<?= $add_data->company_email ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-1">
						<button type="submit" id="subvali" class="btn btn-success stepy-finish">Save
					...
					success: function(data) {
						...
						setTimeout(function() {
							window.location.href =
								"<?php echo base_url(); ?>data_master/approve_prpo/" + <?=$runproject_id;?> ;
						}, 500);
					}
				});
				ev.preventDefault();
