...
<script>var HOST_URL = "<?php echo base_url();?>jsonr/getdatapermission";</script>
			...
			columns: [
				{
					...
					template: function(data) {
						return '<span class="font-weight-bolder">' + data.m_id + '</span>';
					}
				}, {
					field: 'm_id',
					title: 'Employee',
					...
					template: function(row) {
						return '\
							<a href="<?php echo base_url();?>datastore/getpermisstion_project/'+row.m_id+'/'+row.m_code+'" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
								<i class="flaticon-home icon-md"></i>\
							</a>\
							<a href="<?php echo base_url();?>new_permission/edit_permissionnew/'+row.m_user+'" target="_blank" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
								<i class="flaticon-list icon-md"></i>\
							</a>\
						';
					},
				}],
