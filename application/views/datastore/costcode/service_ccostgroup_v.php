                        ...
                        <table id="datasource" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($ccostgroup as $val) {?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>index.php/datastore/ccostsubgroup/<?php echo $val->ctype_code; ?>/<?php echo $val->cgroup_code; ?>"><button class="btn btn-primary btn-block btn-xs"><span class="glyphicon glyphicon-open" aria-hidden="true"></span> เปิด</button></a> </td>
