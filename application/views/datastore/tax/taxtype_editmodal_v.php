        <form action="#" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <input type="hidden" name="taxtype_id_edit" id="taxtype_id_edit" value="<?=$tax[0]['id_taxtype'];?>">
                    <input type="text" class="form-control" id="taxtype_name_edit" placeholder="TAX Name" name="taxtype_name_edit" value="<?=$tax[0]['taxtype_name'];?>">
                </div>
            </div>
            <div class="form-group">
        ...
        <script type="text/javascript">
            $('#tax_save_edit').click(function() {
                var id = $('#taxtype_id_edit').val();
                var name = $('#taxtype_name_edit').val();
                $.post('<?=base_url();?>datastore/edit_taxtype', {id: id ,name: name }, function() {
