...
<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/add_jobtype_nv" id="formcom">
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <h5 class="text-dark-50 font-weight-bold mt-2 mb-2 mr-5">Business job type</h5>
                    <!--end::Page Title-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                                    <li class="nav-item mr-3">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                            ...
                                            <span class="nav-text font-weight-bold">Business job type Details</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="type_code" value="" class="form-control input-sm">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="type_name" name="type_name" value="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
