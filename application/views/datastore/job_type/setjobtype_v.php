                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Business job type
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <a href="<?php echo base_url();?>datastore/add_new_jobtype" class="btn btn-primary font-weight-bolder">
...
<script>var HOST_URL = "<?php echo base_url();?>jsonr/getbusjobtype";</script>
			...
			columns: [
				{
					...
					template: function(row) {
						...
						return '<span class="label ' + status[row.type_active].class + ' label-inline font-weight-bold label-lg">' + status[row.type_active].title + '</span>';
					},
				}, {
					field: 'Actions',
					title: 'Actions',
					...
					template: function(row) {
						return '\
							<a href="<?php echo base_url();?>datastore/edit_jobtype/'+row.type_id+'" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
