<div class="content d-flex flex-column flex-row-fluid" id="kt_wrapper">
    <!--begin::Content-->
       <!--begin::Subheader-->
    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>datastore_active/edit_jobtype_nv" id="formcom">
	<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <h5 class="text-dark-50 font-weight-bold mt-2 mb-2 mr-5">Setup Business job type</h5>
                    <!--end::Page Title-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="<?php echo base_url();?>datastore/master_job_type" class="btn btn-default font-weight-bold">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                                    <li class="nav-item mr-3">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                            ...
                                            <span class="nav-text font-weight-bold">Business Type Details</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input type="text" name="typee_code" readonly="readonly" value="<?php echo $res[0]['type_code']; ?>" class="form-control input-sm form-control-solid">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control input-sm" type="text" id="typee_name" name="typee_name" value="<?php echo $res[0]['type_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" <?= ($res[0]['type_active'] == "1") ? "selected='sleected'" : "";?> >Active</option>
                                            <option value="2" <?= ($res[0]['type_active'] == "2") ? "selected='selected'" : "";?> >Inactive</option>
                                        </select>
