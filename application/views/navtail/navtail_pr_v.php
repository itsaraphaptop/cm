            ...
            <div class="category-content no-padding">
                ...
                <ul class="navigation navigation-main navigation-accordion sidebar-default">
                    ...
                    <li id="purchase">
                        ...
                        <ul>
                            <li>
                                <a id="new_pr" href="<?php echo base_url(); ?>office/openproject">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>New PR</span>
                                </a>
                            </li>
                            <!-- <li>
                                <a id="pr_booking_new" href="<?php echo base_url(); ?>office/openproject_book">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>PR Booking</span>
                                </a>
                            </li> -->
                            <li>
                                <a id="pr_archive" href="<?php echo base_url(); ?>pr/openproject">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>PR Archive</span>
                                </a>
                            </li>
                            <!-- <li>
                                <a id="pb_archive" href="<?php echo base_url(); ?>pr/openbooking">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>PR Booking Archive</span>
                                </a>
                            </li> -->
                            <!-- <li>
                                <a id="pr_decrement" href="<?php echo base_url(); ?>pr/decrement">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>PR Decrement</span>
                                </a>
                            </li> -->
                            <li>
                                <a id="pr_repost" href="<?php echo base_url(); ?>pr_report/pr_summary">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>Report</span>
                                </a>
                            </li>
                            <li>
                                <a id="pr_approve" href="<?php echo base_url(); ?>pr/pr_project_approve">
                                    <i class="icon-radio-unchecked"></i>
                                    <span>Approve </span>
                                </a>
                            </li>
