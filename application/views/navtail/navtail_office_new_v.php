            ...
            <div id="kt_header" class="header header-fixed">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
					...
					<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
						...
						<!--end::Logo-->
                        <?php 
                        $strAction = isset($permission) ? $permission : '';
                        if(is_array($strAction)  > 0) {
                        foreach ($strAction as $num => $key ) {
                            if($key->module_id == 1){
                            if ($key->read == "1") { 
                            if (isset($module_id) == 1) {?>
                        <!--begin::Header Menu-->
                            ...
                            <ul class="menu-nav">
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        <span class="menu-text">Office Service</span>
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="<?php echo base_url();?>data_master/setupcostcode_main_nv/new" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                    ...
                                                    <span class="menu-text">Costcode</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
