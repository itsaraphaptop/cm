...
<div class="navbar navbar-default navbar-fixed-top" style="z-index: 1033;">
	...
	<?php echo $img; ?>" alt=""></a> -->
        ...
        <ul class="nav navbar-nav visible-xs-block">
            ...
            <!-- <li><a id="layout_xs"><i class="icon-paragraph-justify3"></i></a></li> -->
    ...
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav visible-sm-block">
            <!-- <li><a id="layout_sm"><i class="icon-paragraph-justify3"></i></a></li> -->
        </ul>
        <ul class="nav navbar-nav visible-md-block">
            <!-- <li><a id="layout_md"><i class="icon-paragraph-justify3"></i></a></li> -->
        </ul>
        <ul class="nav navbar-nav navbar-right">


            <li class="dropdown des_show">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="icon icon-bell2"></i>
                    <span class="visible-xs-inline-block position-right">Messages</span>
                    <span class="badge bg-warning-400">
                        <?php echo $numpo_reject + $numpr_reject + $numtd + $numpr + $numpo + $numwo + $numpc + $numic + $appnumic + $numfa; ?></span>
                </a>
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <img src="<?php echo base_url(); ?>profile/<?php echo $key->emp_pic; ?>" class="img-circle"
                            ...
                            <div class="media-body">
                                ...
                                <span class="text-muted">คุณ
                                    <?php echo $key->emp_name_t; ?>
                                </span>
                            </div>
                        </li>
...
?>
            ...
            <li class="dropdown dropdown-user des_show">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <!-- <li><a href="<?php echo base_url(); ?>userprofile">
			<i class="preload icon-user-plus"></i> My profile</a>
	</li> -->
                    ...
                    <!-- new setup master contro by setup pernission -->
                    <!-- <?php //if($permission["Setup Option"][66]["read"] == 1){?>
	...
	<?php //}?>-->
                    ...
                    <li>
                        <a href="<?php echo base_url();?>auth/companylist">
                            <i class="icon-office"></i> Change Company</a>
                    </li>
                    <li>
    ...
    <div id="navbar" class="collapse navbar-collapse">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <a href="<?=base_url();?>panel/office">
                ...
                <?php }else{?>
                <img src="<?php echo base_url();?>comp/<?= $comp_img;?>" align="middle" style=" height: 50px;position: absolute;left: 2vh;top: -3.2vh;">
                <?php }?>
            </a>
        </div>
        ...
        <!-- <ul class="nav navbar-nav">
				...
				<li class="side"><a class="sidebar-control sidebar-main-toggle hidden-xs"><i class="icon-transmission"></i></a></li>

			</ul> -->
        <!-- <div class="scrollmenu sidebar-fixed" id="nav_bar"  >
					<a style="width: 150px; text-align: center;" class="active_modul" id="cc" href="<?php echo base_url(); ?>bd/main_index">Cost Control</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="pr" href="<?php echo base_url(); ?>office/main_index">Purchase Requisition</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="po" href="<?php echo base_url(); ?>purchase/main_index">Purchase Order</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="ic" href="<?php echo base_url(); ?>inventory/main_index">Inventory Management</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="fa" href="<?php echo base_url(); ?>add_asset/main_index">Asset Registration</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="ap" href="<?php echo base_url(); ?>ap/main_index">Account Payable</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="ar" href="<?php echo base_url(); ?>ar/main_index">Account Receivable</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="gl" href="<?php echo base_url(); ?>gl/main_index">General Vouncher</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="pm" href="<?php echo base_url(); ?>management/main_index">Project Management</a>
	<a style="width: 150px; text-align: center;" class="active_modul" id="mc" href="<?php echo base_url(); ?>data_master/main_index">Master Configuration</a>
</div> -->
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="password form-control input-lg"
