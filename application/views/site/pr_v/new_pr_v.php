                        ...
                        <div class="row" id="gprpno">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="prpno form-control input-sm" id="prpno" readonly="true">
                            </div>
                          </div>
                          <div class="col-md-4 col-md-offset-4">
                              <label for="purchasedate">วันที่ขอซื้อ</label>
                                <div class="form-group">
                                    <input type="text" name="prdate" class="prdate form-control" id="prdate">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="vender" id="memname" value="<?php echo $name; ?>" readonly="true" placeholder="เลือกผู้ขอซื้อ" class="form-control input-sm">
                                          ...
                                          <!--  <div class="col-md-4" >
                                            ...
                                            <div class="col-md-3">
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type='text' name="deliverydate" class="form-control" id="deliverydate">
                                                </div>
                                              </div>
                                           </div>
                         </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" cols="50"  type="text" name="place" id="place" placeholder="กรอกสถานที่ส่งของ" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                     <label for="remark">หมายเหตุ</label>
                                    <textarea rows="4" cols="50" class="form-control input-sm" type="text" name="remark" id="remark" placeholder="กรอกหมายเหตุ"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-md-6">
      <div class="form-group">
       ...
       <!-- <button class="adddetail btn btn-primary"  id="adddetail" data-toggle="modal" data-target="#opens" data-cost="เลือก">เพิ่มรายการ</button> -->
        <button class="print adddetail btn btn-primary" type="submit">พิมพ์</button>
...
$('.saveprh').click(function(){
  $('.addboxpri').show();
  var url="<?php echo base_url(); ?>index.php/office/add_prmaster";
  var dataSet={
    prdate: $("#prdate").val(),
    memname: $("#memname").val(),
    putproject: $("#putproject").val(),
    putprojectt: $("#putproject1").val(),
    place: $("#place").val(),
