            ...
            <div class="panel-body">
                <div class="tabbable">
                    <ul class="nav nav-tabs nav-tabs-component">
                        <li class="active"><a href="#default-pill1" data-toggle="tab" aria-expanded="false">Project</a></li>
                        <li class=""><a href="#default-pill2" data-toggle="tab" aria-expanded="true">Department</a></li>
                    </ul>
                                        ...
                                        <table class="table table-hover table-striped table-xxs datatable-basic">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="<?php echo base_url(); ?>pr/archive_pr/<?php echo $value->project_id; ?>/p" class="label label-primary preload"><i class="icon-folder-open"></i> Select</a>
                                ...
                                <table class="table table-hover table-striped table-xxs datatable-basic">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>pr/archive_pr_dep/<?php echo $value->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php  if($keysub->chkconbqq=='1'){ echo '<input type="checkbox" checked="checked" disabled="disabled">';}else{ echo '<input type="checkbox"  disabled="disabled">';} ?></td>
                                    <td class="text-center">
                                        <?php  if($keysub->controlbg=='2'){ echo '<input type="checkbox" checked="checked" disabled="disabled">';}else{ echo '<input type="checkbox"  disabled="disabled">';} ?></td>
                                    <td class="text-center"><a href="<?php echo base_url(); ?>pr/pr_approve/<?php echo $keysub->project_code; ?>/<?php echo $keysub->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
