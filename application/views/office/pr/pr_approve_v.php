<?php $pjcode = $this->uri->segment(4); 
$pjid = $this->uri->segment(4); 
$pdcode = $this->uri->segment(3); 
?>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane active" id="top-divided-tab1">
                         <?php
                          ...
                          $this->db->select("pr_remark,purchase_type");
                          $this->db->where('pr_prno',$qq->app_pr);
                          $this->db->where('pr_project',$pjcode);
                          $rem = $this->db->get('pr')->result_array();
                          ?>


                          <div class="hideapp<?php echo $qq->app_pr; ?> panel panel-white panel-collapsed"  <?php if($npr=="0"){ echo "hidden"; } ?>>
                            <div class="panel-heading">
                              <h6 class="panel-title"><?php echo $qq->app_pr; ?> <?php if ($rem[0]['purchase_type']==1) { echo "<label class='label label-warning'>PO/WO</label>"; }elseif($rem[0]['purchase_type']==2){echo "<label class='label label-info'>PO Only</label>";}else{echo "<label class='label bg-purple'>WO Only</label>";}?></h6> 
                              <span>Remark : <?php echo $rem[0]['pr_remark'];?></span>
                              <div class="heading-elements">
                                <ul class="icons-list">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                      <?php $this->db->select('*');
                          ...
                          $this->db->where('pr_prno',$cc->app_pr);
                      $pr=$this->db->get()->result();
                      foreach ($pr as $epr) {
                       $pr_prno = $epr->pr_prno;
                       $pr_prdate = $epr->pr_prdate;
                       $pr_reqname = $epr->pr_reqname;
                       $pr_deliplace = $epr->pr_deliplace;
                       $pr_project = $epr->pr_project;
                       $project_name = $epr->project_name;
                       $pr_remark = $epr->pr_remark;
                       } 
                          ?>
                          <div class="row">
                            <div class="col-md-4">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <h3><i class="icon-file-text2"></i> Detail <?= $pr_project;?></h3>
                              ...
                              <th>No.</th>
                                      ...
                                      <tbody>
                                        <?php   $n =1;?>
                                          ...
                                          $this->db->where('pri_project',$pr_project);
                                          $q =  $this->db->get('pr_item');
                                          $res = $q->result();
                                          foreach ($res as $valj){ ?>
                                        <tr>
                            <td><?php echo $n; ?></td>
                                         <td><?php echo $valj->pri_costcode; ?></td>
                                         <!-- <td><?php echo substr($valj->pri_costcode, -5); ?></td> -->
                                          <td><?php echo $valj->pri_matname; ?></td>
                                           ...
                                           <td><?php echo $valj->pri_remark;?></td>
                                         </tr>
                                          <?php $n++; } ?>
                  ...
                  <div class="modal-footer">
                    <a type="submit" href="<?php echo base_url(); ?>index.php/office/approve_pj_pr/<?php echo $cc->app_id; ?>/<?php echo $qq->app_pr; ?>/<?php echo $pjcode; ?>/<?php echo $cc->app_sequence; ?>/<?php echo $pjid; ?>/<?php echo $pdcode;?>" class="btn bg-success-600">Approve</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div id="reject<?php echo $cc->app_id; ?>" class="modal fade">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/office/reject_pj_pr/<?php echo $cc->app_id; ?>/<?php echo $qq->app_pr; ?>/<?php echo $pjcode; ?>/<?php echo $cc->app_sequence; ?>/<?php echo $pjid; ?>/<?php echo $pdcode;?>" method="post">
                <div class="modal-body">
                <div class="form-group">
                <input type="hidden" name="m_id" value="<?php echo $cc->app_midid;?>">
    ...
    <li <?php if($name1==""){ echo "hidden"; } ?>> &nbsp;<?php echo $name1; ?>  <?php if($tl1=="Y"){ echo '<i style="color:red;"><i class="icon-user-lock"></i><b> LOCK !</b></i>';  } ?> <?php if($ts1!="no"){ echo ' <p style="color: green;"><b>Approved successfully.</b></p>'; }else{ echo '<p style="color: red;"><b>Not verified yet.</b></p>'; } ?>
      ...
      <div id="reject<?php echo $cc->app_id; ?>" class="modal fade">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/office/reject_pj_pr/<?php echo $cc->app_id; ?>/<?php echo $cc->app_pr; ?>/<?php echo $pjcode; ?>/<?php echo $cc->app_sequence; ?>/<?php echo $pjid; ?>" method="post">
                <div class="modal-body">
                <div class="form-group">
                <input type="hidden" name="m_id" value="<?php echo $cc->app_midid;?>">
                <label for="">หมายเหตุ</label>
      ...
      <!-- /main content -->
        <div class="row">
            ...
            <div class="panel panel-flat border-top-lg border-top-warning">
              <div class="panel-heading">
                <h6 class="panel-title">สถานะทำการ Approve เรียบร้อยแล้ว</h6>
                <div class="heading-elements">
                  <ul class="icons-list">
                    <li><a data-action="collapse"></a></li>
                    <li><a data-action="reload"></a></li>
                  ...
                  <table class="table table-hover table-bordered table-xxs">
                    <thead>
                      <tr>
                        ...
                        <td style="text-align: center;">Type of PR</td>
                    ...
                    <?php $n=1; foreach ($getproj1 as $key => $value1) {?>
                      <tr>
                        ...
                        <td style="text-align: center;"><?php echo $value1->app_date; ?></td>
                        <td style="text-align: center;"><?php if($value1->purchase_type=="1"){echo "<span class='label label-warning'>PO/WO</span>";}elseif($value1->purchase_type=="2"){echo "<span class='label bg-info'>PO ONLY</span>";}elseif($value1->purchase_type=="3"){echo "<span class='label bg-purple'>WO ONLY</span>";} ?></td>
                        <td><?php echo $value1->pr_prno; ?></td>
                        <td><?php echo $value1->pr_prdate; ?></td>
                        <td><?php echo $value1->pr_reqname; ?></td>
                        <td><?php echo $value1->project_name; ?></td>
                        <td><a href="<?php echo base_url(); ?>pr_active/cancel_pr_new/<?php echo $value1->pr_prid; ?>/<?php echo $value1->pr_project; ?>/<?php echo $value1->project_code; ?>/<?php echo $value1->pr_prno; ?>" class="btn bg-warning-400 btn-block"><i class="glyphicon glyphicon-remove"> </i> Cancel</a></td>
                      </tr>
                      <?php $n++; } ?>
                    </tbody>
                  </table>
