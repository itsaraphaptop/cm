                        ...
                        <div class="row">
                                    ...
                                    <div class="media no-margin">
                                        ...
                                        <div class="media-body text-right">
                                            <h1 class="no-margin text-semibold">
                                                <?= number_format($pr_count['prnow']) ?>
                                            </h1>
                                            <span class="text-uppercase text-size-mini text-muted">PR ใหม่วันนี้</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="panel panel-body panel-body-accent">
                                    <div class="media no-margin">
                                        <div class="media-left media-middle">
                                            <i class="icon-file-minus icon-3x text-success-400"></i>
                                        </div>

                                        <div class="media-body text-right">
                                            <h1 class="no-margin text-semibold"><?= number_format($pr_count['decrementthis']) ?></h1>
                                            <span class="text-uppercase text-size-mini text-muted">PR Decrement</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-body text-center">
                                    <h6 class="text-semibold no-margin-bottom mt-5">All Summary Purchase Requisition
                                    </h6>
...
<script>
    ...
    lineChartWidgetPettycash('#line_chart_color', 50, 'rgb(102, 187, 106)', 'rgb(102, 187, 106)', 'rgb(102, 187, 106)',
        '#fff');
    ...
    function lineChartWidget(element, chartHeight, lineColor, pathColor, pointerLineColor, pointerBgColor) {
        ...
        // Basic setup
        // ------------------------------
        var url = "<?php echo base_url(); ?>office/getprmonth";
        var datasource = {
            pr: "pr"
        };
    ...
    // pc line Chart 
    function lineChartWidgetPettycash(element, chartHeight, lineColor, pathColor, pointerLineColor, pointerBgColor) {


        // Basic setup
        // ------------------------------
        var url = "<?php echo base_url(); ?>office/getpcmonth";
        var datasource = {
            pr: "pr"
        };
        $.post(url, datasource, function(data) {
    ...
    function animatedPieWithLegend(element, size) {
        ...
        // Add data set
        var url = "<?php echo base_url(); ?>office/getpronut";
        var datasource = {
            pr: "pr"
        };
        $.post(url, datasource, function(data) {
