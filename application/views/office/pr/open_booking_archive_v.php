							...
							<table class="datatable-basic table table-hover table-bordered table-xxs">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><a href="<?php echo base_url(); ?>office/archive_booking/<?php echo $data_pj->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
									</tr>
									<?php
										}
									?>
							...
							<table class="datatable-basic table table-hover table-bordered table-xxs">
								...
								<tbody id="loaddpt">
									...
									<tr>
										...
										<td class="text-center"><a class="label label-warning" data-toggle="modal" data-target="#subd<?php echo $data_pj->project_code;?>">Sub Project</a></td>
