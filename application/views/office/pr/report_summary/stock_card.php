...
<div class="panel panel-flat">
	<div class="modal-header">
		<h6 class="panel-title"><i class="icon-cog3 position-left"></i> Stock Card<p></p></h6>
	</div>
	<form action="<?=base_url() ?>inventory_report/stock_card_r" method="get" id="form_">
	<div class="panel-body">
           ...
           <div class="row">
                ...
                <br>
                 <!-- <div class="row">
                    <div class="col-sm-12">
                        <label class="control-label col-sm-4" style="text-align: right;">Material :</label>
                        <div class="col-sm-4">
...
<script>
    ...
    function get_mat_name(matname){
        ...
        $.post(url, function(){
            ...
            try{
                ...
                $.each(json, function(index, val){
                    $("#mat_name").append("<option value="+val.stock_matcode+">"+val.stock_matcode+"</option>");
                })
            }catch(e){
        ...
        $.post(url, function() {
            ...
            try{
                ...
                $.each(json, function(index, val) {
                    ...
                    $("#fromproject").append("<option value="+val.whcode+">"+val.whname+"</option>");
                });
    ...
    $('#icreport').attr('class', 'active');
    $('#reportstoccard').attr('style', 'background-color:#dedbd8');
    </script>
