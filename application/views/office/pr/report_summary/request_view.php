...
<div class="content">
    <div class="panel panel-flat">
        ...
        <h6 class="panel-title"><i class="icon-cog3 position-left"></i> Request Report PR<p></p></h6>
        </div>
        <form action="pr_request_r" id="fromre" method="get">
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label class="control-label col-sm-4" style="text-align: right;">Project Name :</label>
                        <div class="form-group col-sm-1">
                            <input type="text" class="form-control input-sm" name="proid" id="projectidd" readonly="">
                        </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group col-sm-2">
                            <select name="doct" class="form-control input-sm">
                                ...
                                <option value="1" select>PR Only</option>
