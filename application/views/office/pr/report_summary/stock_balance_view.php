...
<div class="content">
    <div class="panel panel-flat">
        ...
        <h6 class="panel-title"><i class="icon-cog3 position-left"></i>Stock Balance</h6>
        </div>
        <form action="<?=base_url() ?>inventory_report/stock_balance_r" method="get" id="form_">
           ...
           <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control input-sm" id="materials_select" name="Materials" disabled >
                                <option value="">--ทั้งหมด--</option>
                                <?php foreach ($search['stockcard'] as $value) {?>
                ...
                <!-- div class="row">
                    <div class="col-sm-12">
                        <label class="control-label col-sm-4" style="text-align: right;">Materials Name :</label>
                        <div class="col-sm-4">
                            <select class="select-menu2-color" id="fromproject" name="matname">
...
<script>
    function get_po_no(wh,pj_id){
        var url = "<?=base_url()?>pr_report/get_stock_no/"+wh+'/'+pj_id;
        // alert(url);
        $.post(url, function(){
            ...
            try{
                ...
                $.each(json, function(index, val){
                    $("#materials_select").append("<option value="+val.stock_matcode+">"+val.stock_matname+"</option>");
                })
            }catch(e){
        ...
        $.post(url, function() {
            ...
            try{
                ...
                $.each(json, function(index, val) {
                    ...
                    $("#fromproject").append("<option value="+val.whcode+">"+val.whcode+"</option>");
                });
                
                get_po_no($("#fromproject").val(),$("#projectidd").val());

                $("#fromproject").change(function(event) {
                    //alert($(this).val());
                    get_po_no($(this).val(),$("#projectidd").val());
                });
              }catch(e){
