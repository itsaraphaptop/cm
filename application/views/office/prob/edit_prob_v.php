		...
		<form id="probpost" method="post" action="http://cmservice.kudosinnovation.com/base_active/ins_prob">
			...
			<div class="col-xs-6">
				...
				<div class="col-xs-6">
						<div class="form-group">
							...
							<input class="form-control input-sm" id="probno" type="text" name="probno" value="<?php echo $reqid; ?>"	 readonly>
						</div>
					</div>
					<div class="col-xs-6">
						<div class="form-group">
			...
			<div class="col-xs-12">
				<div class="form-group">
					...
					<textarea id="disc" name="disc" class="summernote">
				</div>
			</div>
		...
		frm.submit(function (ev) {
			$.ajax({
				...
				success: function (data) {
					setTimeout(function() {
						window.location.href = "<?php echo base_url(); ?>problems/edit_prob/"+data;
					}, 500);
				}
			});
		ev.preventDefault();
