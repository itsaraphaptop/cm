		...
		<div class="col-xs-12">
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Approve Petty Cash</h5>
				</div>
										...
										<table class="table table-hover table-striped table-xxs datatable-basic">
											<thead>
												...
												<tr>
													...
													<th><a class="label label-warning" data-toggle="modal" data-target="#sub<?php echo $value->project_code;?>">Sub Project</a></th>
													<td><a href="<?php echo base_url(); ?>petty_cash/approve_pc_v/<?php echo $value->project_id; ?>/p/<?php echo $value->project_code; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
...
<div id="sub<?php echo $val->project_code;?>" class="modal fade" data-backdrop="false">
					 <div class="modal-dialog">
                        ...
                        <table class="table table-stripedtable-xxs table-hover">
                          <thead> 
                            <tr>
                              <td class="text-center">No.</td>
                              <td class="text-center">Project Code:</td>
                              <td class="text-center">Project Name:</td>
                              <td class="text-center">Control BOQ</td>
                    		  <td class="text-center">Control Budget</td>
                            ...
                            <?php $k=1; foreach ($sub as $keysub) { ?>
                               <tr>
	                    		...
	                    		<td class="text-center"><?php  if($keysub->controlbg=='2'){ echo '<input type="checkbox" checked="checked" disabled="disabled">';}else{ echo '<input type="checkbox"  disabled="disabled">';} ?></td>
                                  <td><a href="<?php echo base_url(); ?>petty_cash/approve_pc_v/<?php echo $keysub->project_id; ?>/p/<?php echo $keysub->project_code; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
