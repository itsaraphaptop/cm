                                    ...
                                    <div class="media no-margin">
                                        ...
                                        <div class="media-body text-right">
                                            <h1 class="no-margin text-semibold">
                                                <?= number_format($pr_count['pcnow']) ?>
                                            </h1>
                                            <span class="text-uppercase text-size-mini text-muted">PC ใหม่วันนี้</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <h1 class="no-margin text-semibold">
                                            <?= $pr_count['pcthismonth'];?>
                                        </h1>
                                        Petty Cash ทั้งหมดในเดือน
                                        <?php echo date('F',now());?>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-body text-center">
                                    <h6 class="text-semibold no-margin-bottom mt-5">All Summary Petty Cash</h6>
