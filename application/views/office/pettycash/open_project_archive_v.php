          ...
          <!-- Highlighting rows and columns -->
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Archive Petty Cash</h5>
						</div>
                ...
                <thead>
	                ...
	                <tbody>
	                  ...
	                  <tr>
	                    ...
	                    <td><a href="<?php echo base_url(); ?>petty_cash/archive_pettycash/<?php echo $value->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
	                  </tr>
	                  <?php }?>
                </tbody>
              </table>
