<!-- Main content -->
			<div class="content-wrapper">
              ...
              <li><a href="<?php echo base_url(); ?>index.php/petty_cash/approve">Petty Cash Approve</a></li>
              <li>All Petty Cash Status</li>
					</div>
				</div>
				<!-- /page header -->
        	...
        	<div class="col-md-12">
              ...
              <div class="text-right">
                            <a href="<?php echo base_url(); ?>index.php/petty_cash/newpettycash" class="preload btn btn-default"><i class="icon-plus22"></i> New</a>
                ...
                <div class="dataTables_wrapper no-footer">
                  ...
                  <tbody>
                      ...
                      <?php }elseif ($val->approve=="disapprove") {?>
                      ...
                      <td>
                        <ul class="icons-list">
													<?php if ($val->approve=="wait") {?>
														<li><a data-toggle="modal" data-target="#open<?php echo $val->docno; ?>" data-popup="tooltip" title="" data-original-title="Approve"><i class="icon-checkmark4"></i></a></li>
