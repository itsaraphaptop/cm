                ...
                <div class="dataTables_wrapper no-footer">
                  ...
                  <tbody>
                    <?php $n=1; foreach ($res as $k) {?>
                      <tr>
                          <th width="5%"><?php echo $n; ?></th>
													<th width="5%"><?php echo $k->m_code; ?><?php echo $k->vender_code; ?></th>
                          <td><?php echo $k->apo_vender; ?></td>
                          <td>
                            <ul class="icons-list">
                              <li><a class="preload label label-warning" href="<?php echo base_url(); ?>ap/approve_apo_form/<?php echo $k->vender_code; ?><?php echo $k->m_code; ?>" data-popup="tooltip" title="" data-original-title="SELECT"> Select</a></li>
                            </ul>
                          </td>
                      </tr>
                    <?php $n++; } ?>
