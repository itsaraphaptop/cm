      ...
      <form action="<?php echo base_url(); ?>ap_active/addedit_cnv" id="ff" method="post">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-2">
              ...
              <input type="text" id="amount" name="qty" class="form-control input-sm text-right" readonly="true" value="<?=$cnv_head->cnv_netamt;?>" onkeyup="process_cal()" >
              ...
              ?>
                <tr>
                  <td>
                      ...
                      <input type="hidden" class="form-control input-xs" name="vender_code[]" readonly="true" value="<?=$tax->vender_code;?>">
                      <input type="hidden" class="form-control input-xs" name="tax_id[]" readonly="true" value="<?=$tax->id;?>">
                  </td>
                  <td><input type="date" class="form-control input-xs" name="tax_date[]" readonly="true" value="<?=$tax->ap_taxdate;?>"></td>
                  <td><input type="text" class="form-control input-xs" name="taxno[]" readonly="true" value="<?=$tax->ap_taxno;?>"></td>
                  <td><input type="text" class="form-control input-xs text-right amt_tax" readonly="true" onkeyup="cal_process()" name="amtvat[]" id="amt_tax<?=$key+1;?>" value="<?=$tax->ap_amtvat;?>"></td>
                  <td><input type="text" class="form-control input-xs text-right netamt" readonly="true" onkeyup="cal_process()" name="netamt[]" id="netamt_tax<?=$key+1;?>" value="<?=$tax->ap_amtvat;?>"></td>
                </tr>
              <?php
              }
              ?>
        ...
        <div class="modal-footer">
           <div class="form-group">
              ...
              <a href="<?=base_url();?>ap/reduce_apv_report" class="btn btn-primary"><i class="fa fa-mail-reply"></i> Back</a>
            </div>
        </div>
      </form>
    </div>
