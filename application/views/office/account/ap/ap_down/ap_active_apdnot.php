    ...
    <tbody>
        ...
        <tr>
          <td><?php echo $n; ?></td>
            ...
            <td>
              <ul class="icons-list">
                <li><a data-toggle="modal" data-target="#deletecn<?php echo $value->apd_code;?>"><i class="icon-trash"></i></a></li>
...
<div id="deletecn<?php echo $ee->apd_code;?>" class="modal fade" data-backdrop="false">
