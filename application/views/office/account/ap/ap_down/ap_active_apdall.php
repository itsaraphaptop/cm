        ...
        <tr>
          <td><?php echo $n; ?></td>
            ...
            <td>
              ...
              <li><a href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=apd_payvoucher.mrt&no=<?php echo $value->apd_code; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
            ...
            <td>
              <ul class="icons-list">
              <li><a href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=credit_report.mrt&no=<?php echo $value->apd_code; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
              <!-- <li><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=credit_report.mrt&no=<?php echo $value->apd_code; ?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li> -->
              <li><i style="color: #bbb;" class="icon-trash"></i></li>
              </ul>
            </td>
            <?php } ?>
