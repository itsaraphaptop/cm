<div class="table-responsive">
  <table class="basic_open table table-hover table-xxs datatable-basic">
    <thead>
      <tr>
        <th width="5%">No. </th>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td><?php echo $value->cns_date; ?></td>
          <td><?php echo $value->vender_name; ?></td>
          <td><?php echo $value->project_name; ?></td>
          <td>
              <ul class="icons-list">
              <!-- <li><a href="<?php echo base_url(); ?>ap/cnv_edit_reduce/<?php echo $value->cnv_code; ?>" data-popup="tooltip" title=""><i class="icon-pencil7"></i></a></li> -->
