<div class="table-responsive">
  <table class="basic_reduce table table-hover table-xxs datatable-basic">
    <thead>
      <tr>
        <th width="5%">No. </th>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
              ...
              <!-- <li><a href="<?php echo base_url(); ?>ap/cns_open_reduce/<?php echo $value->cns_code; ?>" data-popup="tooltip" title=""><i class="icon-folder-open"></i></a></li> -->
               <li><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=aps_payvoucher.mrt&no=<?php echo $value->cns_code; ?>" data-popup="tooltip" title="" data-original-title="Open"><i class="glyphicon glyphicon-print"></i></a></li>
        ...
        <?php  }else if ($value->cns_status == 'paid') { ?>
              <li><a href="<?php echo base_url(); ?>ap/cnv_open_reduce/<?php echo $value->cns_code; ?>" data-popup="tooltip" title=""><i class="icon-folder-open"></i></a></li>
              </ul>
        <?php  } ?>
        </td>
        </tr>
...
<script>
  ...
  var url="<?php echo base_url(); ?>ap_active/cns_reduce";
  var dataSet={
    comment: $('#comment<?php echo $ee->cns_code;?>').val(),
    code: $('#apscode<?php echo $ee->cns_code;?>').val(),
    type: $('#cns_type<?php echo $ee->type;?>').val(),
  }
