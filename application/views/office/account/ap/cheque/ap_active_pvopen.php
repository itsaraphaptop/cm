        ...
        <tr>
            ...
            <td>
              <ul class="icons-list">
                ...
                <li>
                <a data-toggle="modal" data-target="#cancchq<?php echo $value->ap_code;?>">
                <i class="icon-cancel-square2"></i></a>
                <?php }else{ }  ?>
              </ul>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="sapd<?php echo $ee->ap_code;?>"<i class="icon-floppy-disk"></i> Save</button>
...
<div id="cancchq<?php echo $ee->ap_code;?>" class="modal fade" data-backdrop="false">
    <div class="modal-dialog">
        <div class="modal-content">
      <div class="modal-body">
                <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h5 class="modal-title">ยกเลิกการจ่ายเช็ค <?php echo $ee->ap_code; ?></h5>
        </div>
        <div class="modal-body">
          <input type="hidden" class="form-control" value="<?php echo $ee->ap_code; ?>" name="apvcode" id="codecn<?php echo $ee->ap_code;?>">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="scanc<?php echo $ee->ap_code;?>">บันทึก</button>
...
<script>
  ...
  var url="<?php echo base_url(); ?>ap_cheque/chq_canc";
  var dataSet={
    comment: $('#comment<?php echo $ee->ap_pl;?>').val(),
    code: $('#codecn<?php echo $ee->ap_code;?>').val(),
  }
  $.post(url,dataSet,function(data){
        setTimeout(function() {
          window.location.href = "<?php echo base_url(); ?>index.php/ap/ap_pvapprove_report";
