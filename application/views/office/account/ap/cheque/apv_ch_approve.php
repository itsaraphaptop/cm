<div class="content-wrapper">
  ...
  if ($res==0) {
    ...
    $this->db->select('count(ap_pl) as count_pl');
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="form-group col-sm-2">
                    <label for="">CPC No :</label><div id="cccc"></div>
                    <input type="text" id="ap_no" name="ap_code" class="form-control" value="" readonly="true">
              ...
              <div class="col-md-12">
                <div class="row">    
                  ...
                  <div class="form-group col-sm-2">
                    ...
                    <input type="text" id="pamt" name="pamt" class="form-control border-success border-lg text-success" readonly="true">
                  </div> 
                  <div class="form-group col-sm-2">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <label for="">PL/PV No :</label>
                    <input type="text" readonly="true" class="form-control" id="ap_pl" name="ap_pl" value="<?php echo $jvcode; ?>">
                  </div>
                    <div class="form-group col-sm-2">
                ...
                <div class="table-responsive" id="invoicedown">
                  <table class="table table-hover table-bordered table-striped table-xxs">
                      ...
                      <tr>
                        ...
                        <td><input type="text" id="netmattot" value="0" name="" class="form-control" readonly="true" style="text-align: right;">
                        </td>
                        <td></td>
                      </tr>
                  </table>
              ...
              <script>
                ...
                $(".insrows").click(function(){
                  ...
                  function addrow(){
                    ...
                    '<input type="hidden" name="amount[]" id="amount'+row+'" style="text-align: right;" value="'+amt+'" class="form-control"> '+
                    '</td>'+
                    '<td>'+
                    ...
                    '<td>'+
                    '<input type="text" readonly="true" id="netamt1'+row+'" style="text-align: right;" value="'+net+'" class="form-control"> '+
                    '<input type="text" name="netamti[]" id="netamt'+row+'" style="text-align: right;" readonly="true"  value="'+net+'" class="form-control"> '+
                    '</td>'+
                    '<td>'+
