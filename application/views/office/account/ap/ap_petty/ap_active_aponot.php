          ...
          <td><?php echo $n; ?></td>
            ...
            <td>
              ...
              <li><a href="<?php echo base_url(); ?>ap/ap_edit_apo/<?php echo $val->ap_no; ?>/<?php echo $val->ap_type; ?>" data-popup="tooltip" title=""><i class="icon-pencil7"></i></a></li>
                ...
                <li><a href="<?php echo base_url();?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=apo_payvoucher.mrt&no=<?php echo $val->ap_no; ?>&compcode=<?=$compcode;?>" target="_blank" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
              </ul>
            </td> 
        <?php }else{ ?>
