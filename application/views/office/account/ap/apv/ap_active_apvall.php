      ...
      <tr>
        <td><?php echo $n; ?></td>
          ...
          <?php if ($value->gl_status == 'N') {
            if ($value->apv_status == 'wait') { ?>
          <td>
            <ul class="icons-list">
              <li><a href="<?php echo base_url(); ?>ap/ap_edit_apv/<?php echo $value->apv_code; ?>/<?php echo $value->apv_type; ?>/<?php echo $value->apv_vender; ?>/<?=$value->project_id;?>" data-popup="tooltip" title=""><i class="icon-pencil7"></i></a></li>
            <li><a data-toggle="modal" data-target="#deleteapv<?php echo $value->apv_code;?>"><i class="icon-trash"></i></a></li>
            <li><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ap_payvoucher.mrt&no=<?php echo $value->apv_code; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
            </ul>
          </td> 
          <?php }else{ ?>
          <td>
            <ul class="icons-list">
              ...
              <li><a href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=ap_payvoucher.mrt&no=<?php echo $value->apv_code; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
              <!-- <li><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ap_payvoucher.mrt&no=<?php echo $value->apv_code; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li> -->
            </ul>
          </td> 
          <?php } }else{ ?>
