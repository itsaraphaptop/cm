...
<form action="<?php echo base_url(); ?>ap_active/approve_paid_apv" method="post">
        	...
        	<div class="col-md-12">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <ul class="icons-list">
                      <li><button type="button" class="mo btn btn-warning" data-toggle="modal" data-target="#apvopen"><i class="icon-file-plus"></i> APV SELECT</button></li>
                    </ul>
                  </div>
                </div>
                  ...
                  <table class="table table-bordered table-xxs">
                    ...
                    <tbody id="tbody">
                      <?php $n=1; $total=0; foreach ($resi as $vi) {
                        $query = $this->db->query("select * from apv_header where apv_code ='$vi->doci_apcvcode'");
                        $result = $query->result();
                        $queryi = $this->db->query("select sum(apvi_amount) as amt, sum(apvi_vattot) as vattot from apv_detail where apvi_ref ='$vi->doci_apcvcode'");
                      ...
                      ?>
                                ...
                                <script>
                                  ...
                                  $(document).on('click', 'a#delete<?php echo $vi->doci_apcvcode; ?>', function () { // <-- changes
                                    ...
                                    var apvcode = "<?php echo $vi->doci_apcvcode; ?>";
                ...
                <div class="panel-body">
                  <div class="text-right">
                    ...
                    <a href="<?php echo base_url(); ?>ap/print_approveapvpv/<?php echo $pvno; ?>" class="btn btn-default btn-xs"><i class="icon-printer"></i> Print</a>
...
$(".mo").click(function(){
  var aa = $("#vcode").val();
    ...
    // alert(aa);
    $("#tab").load('<?php echo base_url(); ?>ap/modal_load_apv_approve/'+aa);
});
...
<!-- Full width modal -->
         <div id="apvopen" class="modal fade">
           <div class="modal-dialog modal-lg">
             <div class="modal-content">
               <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal">&times;</button>
                 <h5 class="modal-title">Select APV</h5>
               </div>
