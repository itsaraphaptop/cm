...
<div id="detailreten" class="modal fade" data-backdrop="false">
<div class="modal-dialog modal-full">
<div class="modal-content">
  <div class="modal-header bg-primary">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h5 class="modal-title">ผู้รับจ้าง (<?php echo $lo_lono; ?>) : <?php echo $vender ;?> มูลค่างาน : <?php echo number_format($ap_contractamount) ;?> บาท ยอดคงเหลือ : <?php echo number_format($ap_contractamount-$amoutalltot)  ;?> บาท</h5>
  </div>
    ...
    <table class="table table-bordered table-striped table-xxs">
      <thead>
        <tr>
          ...
          <th >Due Date</th>
          <th >Amout<br>
            <p style="color: red;">(<?php echo $ap_contractamount ;?>)</p></th>
            <th >%</th>
            <th >Down</th>
            <th >Vat<br>
              <p style="color: red;">(<?php echo $allcontract; ?>)</p></th>
              <th >Total Amount<br>
                <p style="color: red;">(<?php echo $all ;?>)</p></th>
                <th >W/H<br><p style="color: red;">(<?php echo $whall ;?>)</th>
                <th >Retention<br>
                  <p style="color: red;">(<?php echo $ap_retentionamount ;?>)</p></th>
                  <th>Net Amout</th>
                  <th>Action</th>
                  <!-- <th >Less Other</th> -->
              ...
              <tbody id="tbody">
                <tr>
                  ...
                  <td class="text-right"><?php echo $key1->ap_bill_date ;?></td>
                  <td class="text-right"><?php echo $key1->ap_bill_duedate ;?></td>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $key->ap_bill_date ;?></td>
                  <td class="text-right"><?php echo $key->ap_bill_duedate ;?></td>
            ...
            <div class="modal-footer">
              <a href="<?php echo base_url(); ?>index.php/aps_active/print_sub/<?php echo $lo_lono; ?>" target="_blank" class="btn btn-link bg-primary" >Print</a>
              <a type="button" class="btn btn-link bg-danger" data-dismiss="modal">Close</a>
              ...
              <table class="table table-bordered table-striped table-xxs">
                ...
                <tbody id="tbody">
                  <tr>
                    ...
                    <td  style="text-align: center;"><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=bill_down.mrt&bill=<?php echo $key1->ap_bill_code ;?>&ap_period=<?php echo $key1->ap_period ;?>&bill_type=<?php echo $key1->ap_bill_type; ?>&compcode=<?php echo $compcode;?> target="_blank"><i class="icon-shredder"></i></a></td>
                  ...
                  <tr>
                    ...
                    <td><?php echo $key->ap_bill_date ;?></td>
                    <td><?php echo $key->ap_bill_duedate ;?></td>
                    <td><?php echo number_format($key->ap_pay) ;?></td>
                    <td  style="text-align: center;"><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=bill_progress.mrt&bill=<?php echo $key->ap_bill_code ;?>&ap_period=<?php echo $key->ap_period ;?>&bill_type=<?php echo $key->ap_bill_type; ?>&compcode=<?php echo $compcode;?>" target="_blank"><i class="icon-shredder"></i></a></td>
