        	...
        	<div class="col-md-12">
						<div class="panel panel-flat border-top-lg border-top-success">
								<div class="panel-heading">
									<h6 class="panel-title">Approve Payment Sub Contracter(APS)</h6>
									<div class="heading-elements">
										<ul class="icons-list">
                  ...
                  <tbody>
                    <?php $n=1; foreach ($res as $k) {?>
                      <tr>
                          ...
                          <td>
                            <ul class="icons-list">
                              <li><a class="preload label label-warning" href="<?php echo base_url(); ?>ap/aps_approve_form/<?php echo $k->aps_contact; ?>" data-popup="tooltip" title="" data-original-title="SELECT"> Select</a></li>
                            </ul>
                          </td>
                      </tr>
                    <?php $n++; } ?>
