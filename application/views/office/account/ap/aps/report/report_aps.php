...
<div id="example" >
    <div class="page-container">
        <div class="pdf-page size-a4">
            ...
            <img src="https://www.barcodesinc.com/generator/image.php?code=<?php echo $apscode; ?>&style=197&type=C128A&width=232&height=50&xres=1&font=3" alt="the barcode printer: free barcode generator" border="0">  </div>  <br>   
                    <p style="font-size:7pt; margin-top:-8px; "> AP Voucher No. : <?php echo $apscode; ?></p>
                    </div>
                        </div>
             </div>
           <script>
    ...
    <div class="row">
             ...
             <div class="input-group">
                    <p style="font-size:10pt;">Date :&nbsp;&nbsp; <?php echo $apsdate; ?> &nbsp;&nbsp; Year : &nbsp;&nbsp;<?php echo date("Y"); ?> &nbsp;&nbsp; Period : &nbsp;&nbsp;<?php echo date("m"); ?></p>
      ...
      <div class="row">         
             ...
             <div class="col-xs-12">
                     ...
                     <p style="font-size:8pt;"><b>โครงการ/แผนก (Project/Department) :</b>  </p>
                     <p style="font-size:8pt; "><b>เจ้าหนี้ (Supplier) :</b>  </p>
                    </div>
                 <div class="col-xs-4">
                     <p style="font-size:8pt;">P/O NO. : </p>
                    </div>

                   <div class="col-xs-3">
                     <p style="font-size:8pt;">ครบกำหนด (Due Date) : </p>
                    </div>

                     <div class="col-xs-3">
                     <p style="font-size:8pt;">Rec NO. : </p>
                    </div>

                    <div class="col-xs-4">
                     <p style="font-size:8pt;">ใบส่งของ ( DO. NO. ). : </p>
                    </div>

                    <div class="col-xs-5">
                     <p style="font-size:8pt;">วันส่งของ ( DO. NO. ). : </p>
                    </div>
