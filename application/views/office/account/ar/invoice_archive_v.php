<!-- Main content -->
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">invoice Archive</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<div class="text-right">
	                          ...
	                          <a href="<?php echo base_url(); ?>panel/office" class="btn btn-default"><i class="icon-close2 position-left"></i> Close</a>
	                         </div>
						</div>
            ...
            <div class="dataTables_wrapper no-footer">
						<div class="table-responsive">
							...
							<thead>
								<tr>
									...
									<th width="30%" class="text-center">Project/Department</th>
									<th width="30%" class="text-center">Owner</th>
                  ...
                  <!-- <th width="5%" class="text-center">Status</th> -->
							...
							<tbody>
								<?php $n=1; foreach ($invoice as $e) {?>
									<tr>
									<td><?php echo $e->inv_no; ?></td>
									<td class="text-center"><span class="label label-success"><?php echo $e->inv_type; ?></span></td>
									<td class="text-center"><?php echo $e->project_name; ?></td>
									<td class="text-center"><?php echo $e->debtor_name; ?></td>
									<td class="text-center"><?php echo $e->inv_date; ?></td>
                  <!-- <td class="text-center"><span class="label label-success"><?php echo $e->inv_type; ?></span></td> -->
									<td>
										<ul class="icons-list">
												...
												<li><a class="preload" href="<?php echo base_url(); ?>ar/ar_edit_down_payment/<?php echo $e->inv_no; ?>" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a></li>
												<li><a href="<?php echo base_url(); ?>ar_active/del_inv/<?php echo $e->inv_no; ?>" data-popup="tooltip" title="" data-original-title="Remove"><i class="icon-trash"></i></a></li>
												<li><a href="<?php echo base_url(); ?>ar_report/report_invoice/<?php echo $e->inv_no; ?>" data-popup="tooltip" title="" data-original-title="Print"><i class="icon-printer4"></i></a></li>
										</ul>
									</td>
									</tr>
									<?php $n++; } ?>
