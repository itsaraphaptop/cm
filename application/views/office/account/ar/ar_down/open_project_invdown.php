								...
								<div class="col-md-12">
										<div class="dataTables_wrapper no-footer">
				                  		...
				                  		<td  class="text-center"><a class="label label-warning" data-toggle="modal" data-target="#sub<?php echo $value->project_code;?>">Sub Project</a></td>
																<td><a href="<?php echo base_url(); ?>index.php/ar/invoice_down/<?php echo $value->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
...
<div id="sub<?php echo $val->project_code;?>" class="modal fade" data-backdrop="false">
					 <div class="modal-dialog">
                        ...
                        <td class="text-center"><a href="<?php echo base_url(); ?>index.php/ar/invoice_down/<?php echo $value->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
