    ...
    <thead>
      ...
      <tr>
        ...
        <td>
          ...
          <input style="text-align: center;width: 100px;" type="text" name="downamti[]" id="downamti<?php echo $n; ?>" value="<?php echo $lkl->inv_downamt; ?>" class="form-control">
        </td>
        <td>
          <input type="text" class="form-control" name="vati[]" id="vati<?php echo $n; ?>" value="<?php echo $lkl->inv_vatamt; ?>" readonly="readonly">
        </td>
        <td>
          <input type="text" class="form-control" name="beforewti[]" id="beforewti<?php echo $n; ?>" value="<?php echo $lkl->inv_beforewt; ?>" readonly="readonly">
        </td>
        <td>
        ...
        <td></td>
         <script>
              $("#downamti<?php echo $n; ?>").keyup(function(){
                var down = parseFloat($("#downamti<?php echo $n; ?>").val());
                var todd = parseFloat($("#todown<?php echo $n; ?>").val());
                ...
                $("#downamti<?php echo $n; ?>").val(down);
                $("#vati<?php echo $n; ?>").val(vatamt);
                $("#beforewti<?php echo $n; ?>").val(downamt);
                $("#lesswti<?php echo $n; ?>").val(lesswt);
                $("#netamti<?php echo $n; ?>").val(tot);
