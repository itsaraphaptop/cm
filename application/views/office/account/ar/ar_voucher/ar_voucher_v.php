...
<div class="content-wrapper">
        ...
        <div class="content">
          ...
          <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url(); ?>ar_active/add_arvoucher">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label>AR No.:</label>
                            <input type="text" class="form-control"  name="vou_no" required id="" placeholder="Voucher No." >
                          </div>
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                <label>Inv No.:</label>
                                <input type="text" class="form-control"  id="invno" name="invno" placeholder="inv no.">
                              </div>
                            </div>
                            <div class="col-md-3">
