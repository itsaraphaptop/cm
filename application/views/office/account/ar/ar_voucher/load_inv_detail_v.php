...
<table class="table table-xxs">
        ...
        <tbody id="body">
          <?php $i=1; $tot=0; foreach ($resi as $value) { ?>
          <tr>
            <td><?php echo $i; ?></td>
          ...
          <!--   <td><input type="text" class="form-control input-sm text-center" name="refpaymentnoi[]" value="<?php echo $value->inv_payref; ?>"></td> -->
            <!-- <td>
              <ul class="icons-list">
          ...
          <?php $i++; $tot=$tot+$value->inv_netamt; } ?>
          <tr>
