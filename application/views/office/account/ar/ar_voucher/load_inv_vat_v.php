  ...
  <tbody>
               ...
               <tr>
                ...
                <th>AMOUNT <input type="hidden" name="gl_type" id="gl_type" value="AMOUNT"></th>
                 ...
                 <td><input type="text" class="form-control input-sm"  name="descrepi[]" id="descrepi<?php echo $n;?>" value="<?php echo $val->inv_desc; ?>"/>
                 </td>
                  <td><input type="text" class="form-control input-sm"  name="vatii[]" id="vatii<?php echo $n;?>" value="<?php echo $val->inv_netamt; ?>"/>
                  </td>
               ...
               $(".loadaccchart<?php echo $n;?>").load('<?php echo base_url(); ?>share/accchart/<?php echo $n; ?>');
                 ...
                 <?php $n++;$i=$n; $total=$total+$val->inv_netamt; } ?>
                 <tr>
