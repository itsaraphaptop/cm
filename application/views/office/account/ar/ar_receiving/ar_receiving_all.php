...
<div class="panel panel-flat">
	...
	<button class="all label bg-orange">Receiving ALL</button>
	<button class="not label label-danger">Receiving not Receipt</button>
	<button class="to label bg-green">Receiving</button>
	</div>
	<script>
		$(".all").click(function(){
			$(".loadtable").html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
			$(".loadtable").load('<?php echo base_url(); ?>ar/arc_receiving_all');
		});
		$(".not").click(function(){
			$(".loadtable").html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
			$(".loadtable").load('<?php echo base_url(); ?>ar/arc_receiving_not');
		});

		$(".to").click(function(){
			$(".loadtable").html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
			$(".loadtable").load('<?php echo base_url(); ?>ar/arc_receiving_to');
		});
	</script>
