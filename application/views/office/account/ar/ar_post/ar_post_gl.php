  ...
  $booknamz = $kgl->booknamz;
    ...
    <div class="page-header">
      <div class="panel-body">
        <form method="post" action="<?php echo base_url(); ?>gl_active/ar_post_gl" id="chk_gl">
        <div class="row">
          <div class="col-sm-12">
          <h4>POST AR TO GL</h4>
          <div class="row">
            ...
            <div class="col-md-2">
                  ...
                  <div class="col-md-3">
                    <label for="">Data Type</label>
                      <select name="datatype" id="datatype" class="form-control input-xs">
                        ...
                        <option value="ar_other">AR Other</option>
                        <option value="ar_trading">AR Trading</option>
                        <option value="ar_down">AR Down</option>
                        <option value="ar_progress">AR Progress</option>
                        <option value="ar_retention">AR Retention</option>
                        <option value="ar_clear">RL</option>
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    ...
                    <input type="text" class="form-control input-xs text-center" id="glyear" name="glyear" value=""  readonly>
                  </div>
                  <div class="col-md-1">
                    <label for="">GL Period :</label>             
                    <input type="text" class="form-control input-xs text-center" id="glperiod" name="glperiod" value=""  readonly>
                  </div>
                </div>
    ...
    <script>
      $('#load_ap').click(function(event) {
        ...
        if ($("#start").val()=="") {
              ...
              $('#transfer').show();
              $('#load_apgl').load('<?php echo base_url(); ?>ar/load_ar_forgl/'+start+'/'+stop+'/'+datatype);
            }
            ...
            frm.submit(function (ev) {
                $.ajax({
                    ...
                    data: frm.serialize(),
                        ...
                        swal({
                                  title: "Data Transfer from AR System",
                                  text: "Save Completed!!.",
                                  // confirmButtonColor: "#66BB6A",
                                  type: "success"
                              });
                         setTimeout(function() {
                        window.location.href = "<?php echo base_url(); ?>ar/ar_post_gl";
                        }, 500);
                    }
                });
                ev.preventDefault();
