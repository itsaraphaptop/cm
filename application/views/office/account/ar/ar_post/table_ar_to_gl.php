...
$this->db->where('ar_gl.acct_no', $k->acct_no);
$this->db->where('ar_gl.costcode', $k->costcode);
$this->db->where('ar_gl.projectid',$k->projectid);
$this->db->where('ar_gl.systemcode',$k->systemcode);
...
<tr>
	...
	<input type="hidden" name="dr[]" value="<?php echo $amtdr; ?>">	
	</td>
	<td class="text-right"><?php echo number_format($amtcr,2); ?>
	<input type="hidden" name="cr[]" value="<?php echo $amtcr; ?>">
	<input type="hidden" name="cust_code[]" value="<?php echo $k->debtor_code; ?>">
	<input type="hidden" name="namecus[]" value="<?php echo $k->debtor_name; ?>">
