          ...
          <tr align="center">
            <td><?php echo $i; ?></td>
              <?php
                ...
                ?>
                <td>
                  <?php echo $key->systemname; ?>
                  <input type="hidden" name="system[]" id="system<?php echo $i; ?>" value="<?php echo $key->systemcode ?>">
                </td>
                <?php
                }
                ?>
              <td>
                <div class="input-group">
                  <input type="text" name="progressamt[]" system_code="<?= $v->inv_system ?>" project_id="<?= $v->project_id ?>" row="<?php echo $i; ?>" id="progressamt<?php echo $i; ?>" value="0" class="form-control text-right">
                  <div class="input-group-btn">
                    <a class="payment btn btn-info btn-icon" system_code="<?= $v->inv_system ?>" project_id="<?= $v->project_id ?>" row="<?php echo $i; ?>" data-toggle="modal" data-target="#my_list"><i class="icon-search4"></i></a>
                  </div>
                </div>
