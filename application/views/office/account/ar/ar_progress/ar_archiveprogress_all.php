		...
		<tr>
			...
			<td>
				<ul class="icons-list">
					...
					?>
					<li>
					<a href="<?php echo base_url(); ?>ar/open_arinvproress/<?php echo $e->inv_no; ?>/<?php echo $e->inv_period; ?>" data-popup="tooltip"><i class="icon-folder-open"></i></a>
					</li>
					<?php
					}	
					?>
					<li><a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ar_invprogress_report.mrt&id=<?php echo $e->inv_no; ?>&period=<?php echo $e->inv_period; ?>&compcode=<?php echo $compcode;?>" data-popup="tooltip" title="" target="_blank" data-original-title="Print"><i class="icon-printer4"></i></a></li>
				 </ul>
			</td>
		</tr>
		<?php $n++; } ?>
