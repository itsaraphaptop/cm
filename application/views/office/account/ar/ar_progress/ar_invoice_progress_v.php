            ...
            <fieldset>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" name="type" id="chk" value="progress">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ref" value="" name="refname" id="refname" readonly>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label>Ref Date: </label>
                        <input type="date" class="form-control daterange-single" id="refdate" name="refdate">
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <label>Due Date: </label>
                      <input type="date" class="form-control daterange-single" id="duedate" name="duedate" readonly="readonly"> 
                  </div>
      ...
      $.get("<?=base_url()?>ar/duedate/"+day, function () {  
          ...
          $('#duedate').val(data);
            ...
            $(window).load(function(){
              $('#invprogress').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
              $("#invprogress").load('<?php echo base_url(); ?>index.php/ar/load_invprogress/<?php echo $project_id; ?>/<?php echo $periodd; ?>');
            });
  ...
  // cal retention
          ...
          <script>
            $('.cer_noref').click(function(event) {
              ...
              $('#cer_no').load('<?php echo base_url(); ?>index.php/ar/load_certification/<?php echo $project_code; ?>/progress');
            });
          </script>