	...
	<div class="content">
		<div class="panel panel-flat">
			<div class="panel-body">
				...
				<form action="<?=base_url();?>ar_report/existing_ar" method="post">
					<div class="row">
						<div class="col-sm-12">
					...
					<br>
						<div class="form-group col-sm-12" style="text-align: right; ">
							...
							<button class="btn btn-info btn-xs" id="print" type="button">Print</button>
							<?php if ($input['data']==1) {
								echo '<button class="btn btn-success btn-xs" type="submit">Save</button>';
							} ?>
							
							<a href="<?=base_url();?>ar_report/view_sale_tax_val" type="button" class="btn btn-danger btn-xs">Close</a>
						</div>
				</form>	
			</div>
		</div>
		...
		<!-- <script type="text/javascript">
			...
			$('#preview').click(function(event) {
				location.href="<?=base_url();?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=report_ap_taxsale_pre.mrt"
			});
