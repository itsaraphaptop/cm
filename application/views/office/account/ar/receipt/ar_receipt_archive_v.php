					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<div class="text-right">
	                          <a href="<?php echo base_url(); ?>ar/receipt" class="preload btn btn-default"><i class="icon-plus22"></i> New</a>
	                          <a href="<?php echo base_url(); ?>ar/ar_receipt_archive" class="btn btn-default"><i class="icon-close2 position-left"></i> Close</a>
	                         </div>
						</div>
                  ...
                  <!-- <th width="5%" class="text-center">Status</th> -->
							...
							<tbody>
								<?php $n=1; foreach ($res as $e) {?>
									...
									<!-- <td><?php echo $e->vou_taxno; ?></td>
									<td class="text-center"><span class="label label-success"><?php echo $e->vou_taxtype; ?></span></td> -->
                  ...
                  <!-- <td class="text-center"><span class="label label-success"><?php echo $e->vou_type; ?></span></td> -->
									<td>
										<ul class="icons-list">
												...
												<li><a class="preload" href="<?php echo base_url(); ?>ar/edit_receipt/<?php echo $e->vou_no; ?>" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a></li>
												...
												<li><a href="<?php echo base_url(); ?>ar_report/report_receipt/<?php echo $e->vou_no; ?>" data-popup="tooltip" title="" data-original-title="Print"><i class="icon-printer4"></i></a></li>
										</ul>
									</td>
									</tr>
									<?php $n++; } ?>
