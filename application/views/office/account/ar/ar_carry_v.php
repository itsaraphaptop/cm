	...
	<div class="content">
		<div class="panel panel-flat">
		  	<div class="panel-heading">
		  		<h4 class="panel-title"> ลูกหนี้คงเหลือยกมา</h4>
			</div>
  			<div class="panel-body">
  			  ...
  			  <!-- </div> -->
  			  <br><br>
  			  <form action="<?=base_url();?>ar_report/add_vender_carry" method="post">
		          ...
		          <table class="basic table table-hover table-xxs" style="width: 5000px;">
		            ...
		            ?>
		              ...
		              <tr class="trdel">
		                <td>
		                	<?=$key+1;?>
		                	<input type="hidden" name="idrow[]" value="<?=$value['arvp_id']?>">
		                ...
		                <td><a class="delete label label-danger del" id-row="<?=$value['arvp_id']?>">Delete</a></td>
		              </tr>
		              <?php } ?>
		            </tbody>
		          </table>
		...
		$('.delete').click(function(event) {
        		...
        		var row_el = $(this).parent().parent();
        			swal({
						...
						function(){
						  $.post('<?=base_url();?>ar_report/del_arvp/'+row_id, function() {
        					}).done(function(data){
        						// alert(data);
