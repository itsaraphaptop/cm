				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Archive PO Reiceive</h5>
						...
						<table class="table table-bordered table-striped table-xxs table-hover datatable-basics">
					          <thead>
						          <tr >
						              	...
						              	<th class="text-center">Invoic No.</th>
					          ...
					          <tbody>
											<?php $n=1; foreach ($res as $v) {
												...
												<tr >
													...
													<td>
														<a data-toggle="modal" data-target="#open<?php echo $v->po_reccode;?>" name="button"><i class="icon-folder-open"></i></a>
														<a href="<?php echo base_url(); ?>report/viewerload?type=ic&typ=receipt_ic&var1=<?php echo $v->po_reccode; ?>&var2=<?php echo $compcode;?>" target="_blank"  name="button"><i class=" icon-printer4"></i></a>
														<!-- <a href="<?php echo base_url(); ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=receipt_ic.mrt&doccode=<?php echo $v->po_reccode; ?>&compcode=<?php echo $compcode;?>" target="_blank"  name="button"><i class=" icon-printer4"></i></a> -->
													</td>
												</tr>
												<?php } ?>
					      	</tbody>
						 ...
						 <div class="modal-content">
							 ...
							 <div class="modal-body">
								 ...
								 <div class="row">
								 	<div class="col-md-6">
								 		<div class="form-group">
											<label for="">Invoic No. : <?php echo $v->taxno; ?></label>
								 		</div>
								 	</div>
									<div class="col-md-6">
								 		<div class="form-group">
								...
								$resi = $q->result(); $o=1;
								 foreach ($resi as $key => $value) {?>
									<tr>
									 ...
									 <td><?php echo $value->poi_receive; ?></td>
