				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo base_url(); ?>index.php/pr/archive_pr">Archive PO Reiceive</a></li>
					</div>
				</div>
				<!-- /page header -->
				<div class="content">
											...
											<?php $n=1; foreach ($res as $v) {?>
												<tr class="text-center">
													...
													<td>
														...
														<?php if ($v->return=="Y") {?>
														<?php }else{  ?>
														<a href="<?php echo base_url(); ?>inventory/edit_receive_po_header/<?php echo $v->po_reccode;  ?>/<?php echo $v->po_pono; ?>/e"  class="label label-warning label-xs" name="button">คืนของ</a>
														<?php } ?>
														<a href="<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=receipt.mrt&doccode=<?php echo $v->po_reccode; ?>"  class="label label-info label-xs" name="button">พิมพ์</a>
													</td>
												</tr>
												<?php } ?>
					      	</tbody>
