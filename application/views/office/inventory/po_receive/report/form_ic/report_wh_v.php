				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Report Stock  Amount And Qty- <?php echo $project; ?></h5>
							<div class="heading-elements">
								<ul class="icons-list">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											 <select id="material" class="select-border-color border-warning" name="material" >
												<option value="0" selected="selected">All Material</option>
              ...
              <div class="row">
								<div class="col-md-6">
									<div class="form-group">
									 ...
									 <div class="col-md-6">
									<div class="form-group">
										<label class="col-lg-3 control-label">WareHouse :</label>
										<div class="col-lg-9">
											 <select id="whcode" class="select-border-color border-warning" name="whcode" >
												<option value="0" selected="selected">All Warehouse</option>
												<?php foreach ($getwh as $valwh) {?>
													<option value="<?php echo $valwh->whcode; ?>"><?php echo $valwh->whcode; ?> - <?php echo $valwh->whname; ?></option>
												<?php } ?>
											</select> 
									</div>
								</div>
		              ...
		              <div class="dataTables_wrapper no-footer">
		  						<div class="table-responsive">
									...
									<thead>
									    ...
									    <th  class="text-center">BF. QTY</th>
									    <th  class="text-center">Receipt Qty</th>
									    <th  class="text-center">Total Receipt Qty</th>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	$('#btntable').click(function() {
		...
		if ($('#whcode').val()=="" && $('#material').val()=="") {
			var whcode = "0";
			var material = "0";
			
		}else if($('#whcode').val()!="" && $('#material').val()!="" ){
			var whcode = $('#whcode').val();
			var material = $('#material').val();
		...
		if ($("#chki").val()=="fifo") {
	    	...
	    	$("#loadtable").load('<?php echo base_url(); ?>get_qty/fifo/'+material+'/'+whcode+'/'+pjcode+'/'+stdate+'/'+eddate);
    	}else{
    		$('#loadtable').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
    		$("#loadtable").load('<?php echo base_url(); ?>get_qty/wh/'+material+'/'+whcode+'/'+pjcode+'/'+stdate+'/'+eddate);
    	}
	});
