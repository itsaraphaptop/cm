					...
					<div class="panel panel-flat">
						<div class="panel-heading">
						  <?php foreach ($getproj as $key => $value) {?>
							<h5 class="panel-title">Document Receive Report For Project <?php echo $value->project_name; ?></h5>
							<?php } ?>
							<div class="heading-elements">
								<ul class="icons-list">
								...
								<div class="col-md-6">
										...
										<div class="col-lg-9">
											 <select id="material" class="select-border-color border-warning" name="material" >
												...
												<option value="1" selected="selected">Document No.</option>
												<option value="2" >item Code</option>
												<option value="3" >PO NO.</option>
												<option value="4" >Vendor Code</option>
												<option value="5" >Warehouse</option>
												<!-- <option value="6" >By Area</option> -->
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	$('#btntable').click(function() {
		...
		if ($("#chki").val()=="fifo") {
	    	...
	    	$("#loadtable").load('<?php echo base_url(); ?>stock_issue/Rcqty/'+material+'/'+stdate+'/'+eddate);
    	}else{
    		$('#loadtable').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
    		$("#loadtable").load('<?php echo base_url(); ?>stock_issue/Rcqty/'+material+'/'+stdate+'/'+eddate+'/'+context+'/'+pjwh);
    	}
	});
