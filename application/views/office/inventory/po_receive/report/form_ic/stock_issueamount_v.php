								...
								<div class="col-md-6">
										...
										<div class="col-lg-9">
											 <select id="material" class="select-border-color border-warning" name="material" >
												...
												<option value="2" >Entry By.</option>
		              ...
		              <div class="dataTables_wrapper no-footer">
		  						<div class="table-responsive">
									...
									<thead>
									    ...
									    <th  class="text-center">Balance Unit</th>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	$('#btntable').click(function() {
		...
		if ($("#chki").val()=="fifo") {
	    	...
	    	$("#loadtable").load('<?php echo base_url(); ?>stock_issue/Stock_issueamount31/'+material+'/'+stdate+'/'+eddate);
    	}else{
    		$('#loadtable').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
    		$("#loadtable").load('<?php echo base_url(); ?>stock_issue/Stock_issueamount31/'+material+'/'+stdate+'/'+eddate+'/'+context+'/'+pjwh);
    	}
	});
