				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Report Stock Area - Qty <?php echo $project; ?></h5>
							<div class="heading-elements">
								<ul class="icons-list">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	$('#btntable').click(function() {
		...
		if ($("#chki").val()=="fifo") {
	    	...
	    	$("#loadtable").load('<?php echo base_url(); ?>stock_issue/stock_areaqty/'+material+'/'+stdate+'/'+eddate);
    	}else{
    		$('#loadtable').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
    		$("#loadtable").load('<?php echo base_url(); ?>stock_issue/stock_areaqty/'+material+'/'+stdate+'/'+eddate+'/'+context+'/'+pjwh);
    	}
	});
