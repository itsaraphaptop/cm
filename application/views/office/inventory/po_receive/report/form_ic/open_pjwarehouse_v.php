              ...
              <table class="table table-hover table-bordered table-xxs">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>index.php/report_qty/report_warehouse/<?php echo $value->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
