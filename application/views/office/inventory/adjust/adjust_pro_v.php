					            ...
					            <table class="table table-hover table-bordered  table-xxs datatable-basic">
									...
									<tbody>
											...
											<tr>
												...
												<td><a href="<?php echo base_url(); ?>index.php/inventory/ic_adjust_v/<?php echo $value->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
