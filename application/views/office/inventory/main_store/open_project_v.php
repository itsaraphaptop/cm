              ...
              <div class="table-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    	<a href="<?php echo base_url(); ?>index.php/inventory/store_list/<?php echo $value->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a>
                    <?php if ($username=="admin" || $username=="thanyaporn" || $username=="nittaya") {?>
                    	<a href="<?php echo base_url(); ?>index.php/inventory/store_list_update/<?php echo $value->project_id; ?>" class="label label-info"><i class="icon-database-edit2"></i> ปรับปรุงยอด</a>
                    <?php } ?>
                    </td>
                  </tr>
                  <?php } ?>
