	...
	<!-- <form  action="<?php echo base_url(); ?>inventory/receive_table_stockcard_use/" method="post"> -->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-lg-9">
											<!-- <input type="text" class="form-control" placeholder="" id="material" name="material"> -->
                ...
                <div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-lg-9">
											<!-- <input type="text" class="select-border-color border-warning" placeholder="" id="materialend" name="materialend"> -->
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/plugins/forms/styling/switchery.min.js"></script>
	...
	$('#btntable').click(function() {
		...
		if ($("#chki").val()=="fifo") {
	    	...
	    	$("#loadtable").load('<?php echo base_url(); ?>get_stocktranmove/fifo/'+material+'/'+materialend+'/'+pjcode+'/'+stdate+'/'+eddate);
    	}else{
    		$('#loadtable').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
    		$("#loadtable").load('<?php echo base_url(); ?>get_stocktranmove/averrage/'+material+'/'+materialend+'/'+pjcode+'/'+stdate+'/'+eddate);
    	}
	});
