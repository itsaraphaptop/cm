...
<div class="panel panel-flat">
    <div class="modal-header">
        <h6 class="panel-title"><i class="icon-cog3 position-left"></i> Stock IN<p></p></h6>
    </div>
    <form action="<?=base_url()?>inventory_report/stock_in_r" method="get" id="form_">
...
<script>
    ...
    function get_po_no(wh){
        var url = "<?=base_url()?>pr_report/get_stock_no_in/"+wh;
        // alert(url);
        $.post(url, function(){
    ...
    function get_mat_name(matname){
        var url = "<?=base_url()?>pr_report/get_mat_code_by_stock_on_in/"+matname;
        // alert(url);
        $.post(url, function(){
    ...
    function get_project_id(el){
        ...
        var url = "<?=base_url()?>pr_report/get_wh_in/"+project_id;
        // alert(url)
        $.post(url, function() {
