                ...
                <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly="readonly" id="docno" placeholder="Goods Issue Document">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly="readonly" name="name" id="memname" placeholder="User Issue" value="<?php echo $name; ?>">
                           ...
                           $pj = $value->project_name;
                            } ?>
                            <input type="text" class="form-control" readonly="readonly" placeholder="โครงการ" value="<?php echo $pj ?>" name="projectname" id="projectname">
                             <input type="hidden" readonly="true" class="pproject form-control input-sm" value="<?php echo $projid; ?>" name="projectid" id="putprojectid">
                            <div class="input-group-btn">
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="code">System Type</label>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" readonly="" class="form-control" name="bookcode" id="bookno" >
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="input-group">
                                ...
                                <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                <input type="text" class="form-control daterange-single" name="bookdate" id="bookdate" >
                              </div>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <fieldset>
                            <div class="form-group">
                              <label>Remark :</label>
                              <textarea rows="5" cols="5" id="c" class="form-control" required="required" placeholder="Remark" name="remark"></textarea>
                            </div>
                          </fieldset>
                      </div>
                      <div class="col-md-6">
                         <fieldset>
                            ...
                            <textarea rows="5" cols="5" class="form-control"  placeholder="สถานที่ใช้งาน" name="place" id="place"></textarea>
                          </div>
                          </fieldset>
                      </div>
                    </div>
         ...
         $.ajax({
             ...
             data: frm.serialize(),
                 ...
                 swal({
                  ...
                  setTimeout(function() {
                        // window.location.href = "<?php $base_url = $this->config->item('url_report'); echo $base_url; ?>stimulsoft/Flex/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ic_issue.mrt&doccode="+data+"&compcode=<?=$compcode;?>";
                        window.location.href = "<?php echo base_url(); ?>report/viewerload?type=ic&typ=ic_issue&var1="+$.trim(data)+"&var2=<?=$compcode;?>";
                 }, 500);
             }
         });
         ev.preventDefault();
...
//
          ...
          <!-- modal  booking-->
           <div class="modal fade" id="openbook" data-backdrop="false">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header bg-primary">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="myModalLabel">Retrive Booking</h4>
                </div>
                  <div class="modal-body">
                  <div class="panel-body">
                      <div class="row" id="modal_booking">
        ...
        $(".openbook").click(function(){
              $('#modal_booking').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
              $("#modal_booking").load('<?php echo base_url(); ?>inventory/retrive_booking/<?php echo $projid; ?>');
