          ...
          <div class="row">
            <div class="panel panel-flat">
              <div class="panel-heading">
                <h5 class="panel-title">Goods Trading Document <div class="pull-right">
                            <a data-toggle="modal" data-target="#openbook" class="openbook btn btn-info"><i class=" icon-file-plus"></i> Select</a>
                            </div></h5>
                  </div>
              <div class="panel-body">
                <form id="insertform" name="insertform" action="<?php echo base_url(); ?>index.php/inventory_active/add_doc_trading" method="post">
                <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label>Goods Trading Document:</label>
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label>Goods Trading Date: </label>
                                <div class="input-group">
                      ...
                      <div class="col-md-6">
                         <fieldset>
                             <div class="form-group">
                            <label>Trading for Area Work:</label>
...
//
          ...
          $(".openbook").click(function(){
              ...
              $("#modal_booking").load('<?php echo base_url(); ?>inventory/retrive_booking_trading/<?php echo $projid; ?>');
