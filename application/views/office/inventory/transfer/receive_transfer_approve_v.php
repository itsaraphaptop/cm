    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Transfer Approve</h5>
                <h3>
                    <?php echo @$getprojto;?>
                </h3>
            ...
            <div class="modal-dialog modal-full">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-body">
                            <form id="postreceive" action="<?php echo base_url(); ?>inventory_active/approve_transfer/<?=$id?>"
                                method="post">
                                <div class="row">
                                    <!--  -->
        ...
        <script>
            ...
            $('#imp_sub101').attr('style', 'background-color:#dedbd8');
        </script>
        <?php } ?>
