	...
	<tbody>
               ...
               <tr>
                <th scope="row"><?php echo $n;?></th>
                 ...
                 <td><?php echo number_format(($amount+$val->poi_amount*7/100),2); ?></td>
                 <td><?php echo number_format(($amount+$val->poi_amount*7/100)+$val->poi_netamt,2); ?></td>
               </tr>
                 <?php
                   $n++;
                   $totq=$qt+$val->poi_qty;
                   ...
                   $total=($total+$val->poi_netamt)+$vat;
                 } ?>
