             ...
             <tbody>
               ...
               <tr>
                <th scope="row"><?php echo $n;?></th>
                 ...
                 <!-- <td><?php echo number_format($val->poi_disamt,2); ?></td> -->
                 <td><?php echo number_format($val->poi_netamt,2); ?></td>
                 <!-- <td><button class="btn btn-xs btn-block btn-info" data-toggle="modal" data-target="#modaleditdetail<?php echo $val->poi_id;?>">แก้ไข</button></td>
                 <td><a href="#"><button class="btn btn-xs btn-block btn-danger">ลบ</button></a></td> -->
               </tr>
                 <?php
                   $n++;
                   $totq=$qt+$val->poi_qty;
                 ...
                 <tr class="success" style="color:#009900"><td colspan="4"><div class='text-center'>รวม</div>  </td>  
