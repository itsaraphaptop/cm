<?php foreach ($apvdetail as $val) {
  $code = $val->apv_code;
  $vender_name = $val->vender_name;
  $pono = $val->apv_pono;
  $invno = $val->apv_inv;
  $duedate = $val->apv_duedate;
  $cterm = $val->apv_crterm;
  $apvdate = $val->apv_date;
  $projectname = $val->project_name;
  $projecid = $val->project_id;
  $departmentname = $val->department_title;
  $departmentid = $val->department_id;
  $system = $val->apv_system;
  $do = $val->apv_do;
} ?>
    ...
    <div class="row">
      ...
      <label for="">ร้านค้า</label>
        <div class="input-group">
          <input type="text" class="form-control input-sm" value="<?php echo $vender_name; ?>"  placeholder="ร้านค้า" id="vender">
      ...
      <div class="col-xs-4">
        <div class="form-group">
          ...
          <input type="text" class="form-control input-sm"  placeholder="เลขที่ใบสั่งซื้อ" value="<?php echo $pono; ?>"  id="pono" required>
      ...
      <div class="col-xs-4">
        <div class="form-group">
          ...
          <input type="text" class="form-control input-sm" value="<?php echo $code; ?>" placeholder="เลขที่ใบตั้งเจ้าหนี้" id="apvno">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-4">
        ...
        <input type="text" class="form-control input-sm" value="<?php echo $invno; ?>" id="invno" placeholder="เลขทีใบส่งของ">
        </div>
      </div>
      <div class="col-xs-3">
      <label for="">วันที่ส่งมอบ</label>
        <div class="form-group">
          <input type="text" class="form-control" value="<?php echo $duedate; ?>"  placeholder="วันที่ส่งมอบ" id="duedate">
        </div>
      </div>
      <div class="col-xs-2">
      <label for="">เงื่อนไขชำระ</label>
        <div class="input-group">
          <input type="text" class="form-control input-sm" value="<?php echo $cterm; ?>" id="cterm" placeholder="เงื่อนไขชำระ">
      ...
      <div class="col-xs-2">
        ...
        <label for="">วันที่ใบสำคัญจ่าย</label>
          <input type="text" class="form-control" value="<?php echo $apvdate; ?>" id="apvdate" placeholder="วันที่ใบสำคัญจ่าย">         
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-4">
       ...
       <div class="input-group">
                <input type="text" readonly="true" value="<?php echo $projectname; ?>" class="form-control input-sm" id="projectnam">
                <input type="hidden" readonly="true" value="<?php echo $projecid; ?>" class="form-control input-sm" name="project" id="putproject">
                <span class="input-group-btn">
      ...
      <div class="col-xs-4">
        <div class="form-group">
          ...
          <input type="text" class="form-control input-sm" value="<?php echo $do; ?>" placeholder="เลขี่ใบรับของ" id="porecx">
        </div>
      </div>
      </div>
      <div class="row">
      ...
      <div class="col-xs-4" >
            <div class="input-group">
             <label for="project1">แผนก</label>
                <input type="text" readonly="true" value="<?php echo $departmentname; ?>" class="form-control input-sm input-sm" id="dptnam">
                <input type="hidden" readonly="true" value="<?php echo $departmentid; ?>" class="form-control input-sm input-sm" name="department" id="putdpt">
                <span class="input-group-btn">
...
<script>
  $('.edith').click(function(event) {
    var url="<?php echo base_url(); ?>index.php/acc_active/editapv_h_";
    var dataset={
      code: $('#apvno').val(),
      vender: $("#vender").val(),
      pono: $("#pono").val(),
...
<script>
 ...
 <script>
  $('.print').click(function(){
   var pp = $('#apvno').val();
   var po = $("#pono").val();
     url = "<?php echo base_url(); ?>index.php/report/newapv_report"+"/"+pp;
