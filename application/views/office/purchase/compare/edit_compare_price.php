			...
			<form method="post" id="savepost" name="savepost" action="<?php echo base_url(); ?>purchase_active/add_comprice">
				<div class="panel panel-flat border-top-lg border-top-success">
					<div class="panel-heading ">
						<h5 class="panel-title">edit การทำใบขอราคาและเปรียบเทียบราคาสินค้า</h5>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-2">
								<div class="form-group">
									<label>Compare Code.:</label>
									<input type="text" class="form-control"  name="comparecode" readonly="true" id="comparecode" value="<?php echo $getcompare[0]['pr_code'];?>"  >
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label>PR No.:</label>
									<input type="text" class="form-control"  name="prno" readonly="true" id="prno" placeholder="PR No." value="<?php echo $getcompare[0]['pr_prno'];?>"  >
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-2">
								<div class="form-group">
									<label>วันที่ :</label>
									<input type="date" class="form-control"  name="comparedate" readonly="true" id="comparedate" value="<?php echo $getcompare[0]['pr_prdate'];?>">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label>วันที่ส่งของ :</label>
									<input type="date" class="form-control"  name="docdate" readonly="true" id="docdate" value="<?php echo $getcompare[0]['pr_prdate'];?>">
								</div>
							</div>
							<div class="col-md-5">
								<div class="form-group">
									<label>สถานที่ส่งของ :</label>
									<textarea class="form-control" id="place" name="place" readonly=""><?php echo $getcompare[0]['pr_place'];?></textarea>
								</div>
							</div>
						</div>
...
<script>
	  $( window ).on( "load", function() {
		...
		$("#invoice").load('<?php echo base_url(); ?>purchase/load_compare_detail/<?php echo $getcompare[0]['pr_code']; ?>');
		$('#paird').html("<img src='<?php echo base_url();?>assets/images/loading.gif'> Loading...");
		$("#paird").load('<?php echo base_url(); ?>purchase/load_compare_vender/<?php echo $getcompare[0]['pr_code']; ?>');
	});
