        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-flat">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="active">
                            <a href="#bottom-tab1" data-toggle="tab">PO OVERVIEW </a>
                        </li>
                    </ul>
                        ...
                        <div class="row row-condensed">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <!-- <h4 class="no-margin text-semibold">ใบสั่งซื้อ</h4> -->
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg newpo">
                                        <i class="icon-file-plus"></i>
                                        <span>New PO</span>
                                    </button>
                                    <?php 
                                    $q=0; if($pr_type['typepw']!=0){
                                        echo "<span class='badge bg-danger-400 custombadge'>".$pr_type['typepw']."</span>";
                                    }else{
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg newwo">
                                        <i class="icon-file-plus"></i>
                                        <span>New WO</span>
                                    </button>
                                    <?php 
                                    $q=0; if($pr_type['typewo']!=0){
                                        echo "<span class='badge bg-danger-400 custombadge'>".$pr_type['typewo']."</span>";
                                    }else{

                                    } ?>
                                </div>
                                <div class="form-group">
                                    <!-- <h4 class="no-margin text-semibold">อนุมัติใบสั่งซื้อ</h4> -->
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg apprpo">
                                        <i class="icon-file-check2"></i>
                                        <span>Approve PO</span>
                                    </button>
                                    <?php 
                                    $q=0; if($pr_type['po_wait']!=0){
                                        echo "<span class='badge bg-danger-400 custombadge'>".$pr_type['po_wait']."</span>";
                                    }else{
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg apprwo">
                                        <i class="icon-file-check2"></i>
                                        <span>Approve WO</span>
                                    </button>
                                    <?php 
                                    $q=0; if($pr_type['lo_wait']!=0){
                                        echo "<span class='badge bg-danger-400 custombadge'>".$pr_type['lo_wait']."</span>";
                                    }else{
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <!-- <h4 class="no-margin text-semibold">เอกสารใบสั่งซื้อ</h4> -->
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg archpo">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg archwo">
                                        <i class="icon-archive"></i>
                                        <span>WO Archive</span>
                                    </button>
                                </div>
                                <div class="form-group">
                                    <!-- <h4 class="no-margin text-semibold">ลดยอดใบสั่งซื้อ</h4> -->
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg decrempo">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default btn-block btn-float btn-float-lg report">
            ...
            <script>
                $(".newpo").click(function() {
                    window.location.href = "<?php echo base_url();?>purchase/opencreatepo";
                });
                $(".newwo").click(function() {
                    window.location.href = "<?php echo base_url();?>contract/newcontract";
                });
                $(".apprpo").click(function() {
                    window.location.href = "<?php echo base_url();?>purchase/po_approve";
                });
                $(".apprwo").click(function() {
                    window.location.href = "<?php echo base_url();?>contract/newapprovecontract";
                });
                $(".archpo").click(function() {
                    window.location.href = "<?php echo base_url();?>purchase/openproject/poarchive";
                });
                $(".archwo").click(function() {
                    window.location.href = "<?php echo base_url();?>contract/openproject";
                });
                $(".decrempo").click(function() {
                    window.location.href = "<?php echo base_url();?>po_decrement";
                });
                        ...
                        <div class="row">
                                ...
                                <div class="panel panel-body panel-body-accent">
                                    <div class="media no-margin">
                                        <div class="media-left media-middle">
                                            <i class="icon-files-empty icon-3x text-primary-400"></i>
                                        </div>

                                        <div class="media-body text-right">
                                            <h1 class="no-margin text-semibold">
                                                <?=number_format($po_count['ponow']);?>
                                            </h1>
                                            <span class="text-uppercase text-size-mini text-muted">PO ใหม่วันนี้</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel panel-body panel-body-accent">
                                    <div class="media no-margin">
                                        ...
                                        <div class="media-body text-right">
                                            ...
                                            <span class="text-uppercase text-size-mini text-muted">WO ใหม่วันนี้</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="panel panel-body panel-body-accent">
                                    <div class="media no-margin">
                                        <div class="media-left media-middle">
                                            <i class="icon-file-minus icon-3x text-primary-400"></i>
                                        </div>

                                        <div class="media-body text-right">
                                            <h1 class="no-margin text-semibold">
                                                <?= number_format($po_count['decrementthis']);?>
                                            </h1>
                                            <span class="text-uppercase text-size-mini text-muted">PO Decrement</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="panel has-bg-image">
                                    <div class="panel-body">
                                        ...
                                        <h1 class="no-margin text-semibold">
                                            <?= number_format($po_count['thismonth']);?>
                                        </h1>
                                        PO ทั้งหมดในเดือน
                                        <?php echo date('F Y',now());?>
                                        <div class="text-muted text-size-small">528 avg</div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-body text-center">
                                    <h6 class="text-semibold no-margin-bottom mt-5">All Summary Purchase Order</h6>
                                    ...
                                    <!-- <div class="panel-body panel-body-accent pb-15">
										<div class="row">
											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">PO APPROVE</div>
												<h1 class="text-semibold no-margin">10</h1>
											</div>

											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">IN PROCESS</div>
												<h1 class="text-semibold no-margin">5</h1>
											</div>

											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">PO REJECT</div>
												<h1 class="text-semibold no-margin">1</h1>
											</div>
										</div>
									</div> -->
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="panel panel-body text-center">
                                    ...
                                    <!-- <div class="panel-body panel-body-accent pb-15">
										<div class="row">
											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">WO APPROVE</div>
												<h1 class="text-semibold no-margin">5</h1>
											</div>

											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">IN PROCESS</div>
												<h1 class="text-semibold no-margin">2</h1>
											</div>

											<div class="col-xs-4">
												<div class="text-uppercase text-size-mini text-muted">WO REJECT</div>
												<h1 class="text-semibold no-margin">2</h1>
											</div>
										</div>
									</div> -->
