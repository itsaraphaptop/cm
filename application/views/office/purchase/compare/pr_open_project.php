											...
											<table class="table table-hover table-bordered  table-xxs datatable-basic">
												...
												<tbody>
													...
													<tr>
														...
														<?php if($menu=="rq"){?>
															<td class="text-center"><a href="<?php echo base_url(); ?>index.php/purchase/compare_price_v/<?php echo $value->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
														<?php }else{ ?>
															<td class="text-center"><a href="<?php echo base_url(); ?>index.php/purchase/new_compare_price/<?php echo $value->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
														<?php } ?>
													</tr>
													<?php } ?>
												</tbody>
									...
									<table class="table table-hover table-bordered table-xxs datatable-basic">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="<?php echo base_url(); ?>index.php/purchase/compare_price_v/<?php echo $value->project_id; ?>/p" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
						...
						<table class="table table-bordered table-xxs table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><a href="<?php echo base_url(); ?>index.php/pr/pr_approve/<?php echo $keysub->project_code; ?>/<?php echo $keysub->project_id; ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a></td>
