<div class="modal-header bg-info">
  <button type="button" class="close" id="delclo" data-dismiss="modal">x</button>
  <h2><?php echo $id; ?></h2>
</div>
<div class="modal-body">
  ...
  <table class="table table-hover table-bordered table-striped table-xxs">
    ...
    <tbody id="body">
     ...
     <tr id="chk<?php echo $u->pri_id; ?>">
        ...
        <td><?php if ($u->boq_type == "1") {echo "<label class='label bg-primary'>Material</label>";}else if($u->boq_type=="2"){echo "<label class='label bg-warning'>LABOR</label>";}else if($u->boq_type=="0"){echo "<label class='label bg-warning'>NON Budget</label>";}?></td>
      ...
      var pri_pqtyic = '<?php echo ((int)$u->pri_qty - (int)$u->pri_sumqty) * (int)$u->pri_cpqtyic; ?>';
      ...
      if(ckkcontrolbg=="2"){
      var m = $('#costbgmat<?php echo $u->pri_costcode; ?>').val();
      var l = $('#costbglebour<?php echo $u->pri_costcode; ?>').val();
      var s = $('#costbgsub<?php echo $u->pri_costcode; ?>').val();
      }else{
      var m = "0";
      var l = "0";
      var s = "0";  
      ...
      var tr = '<tr id="'+row+'">'+
        ...
        '<td id="smatname'+row+'">'+pri_matname+'<input type="hidden" name="matnamei[]" id="matnametext'+row+'" value="'+pri_matname+'"></td>'+
      ...
      '</td>'+
      '<td  class="text-right" id="tto_di'+row+'">'+numberWithCommas(pri_disamt)+'<input type="hidden" id="zum'+row+'" name="too_di[]" value="'+pri_disamt+'">'+
      ...
      '<input type="hidden" name="pri_woref[]" value="'+pri_woref+'">'+
    ...
    '<div class="modal-dialog modal-lg">'+
      '<div class="modal-content">'+
        ...
        '<button type="button" class="close" data-dismiss="modal">x</button>'+
          '<h5 class="modal-title">รายการ. '+pri_matname+'</h5>'+
        '</div>'+
        '<div class="modal-body">'+
          '<div class="row">'+
            '<div class="col-xs-6">'+
          ...
          '<div class="row">'+
            '<div class="col-md-6">'+
              '<div class="form-group">'+
                ...
                '<input type="text" id="remark_mat'+row+'" name="remark_mat"  class="form-control" value="'+remark_mat+'">'+
              '</div>'+
             '</div>'+
              ...
              '<div class="col-md-3">'+
                 '<div class="form-group">'+
                  ...
                  '<option value=""></option>'+
                      ...
                      '<option value="4">NON Budget</option>'+
                    '</select>'+
                '</div>'+
              '</div>'+
              '<div class="col-md-3"  '+chk1+'>'+
                 '<div class="form-group">'+
      '<li style="color: blue;">MAT. = '+ m +'</li>'+
                 '<li style="color: blue;">LAB. = '+l+'</li>'+
                 '<li style="color: blue;">SUB. = '+s+'</li>'+
                 '</div>'+
              '</div>'+
            '</div>'+
            '<div class="row">'+
            ...
            ' <div class="row">'+
              ...
              '<div class="col-md-6">'+
                ' <div class="form-group">'+
                  ...
                  '<input type="text" id="pamount'+row+'" name="amount" placeholder="กรอกจำนวนเงิน" class="form-control text-right" value="'+pri_amount+'">'+
                '</div>'+
              '</div>'+
            '</div>'+
            '<div class="row">'+
            ...
            '<div class="row">'+
              ...
              '<div class="col-md-4">'+
                '<div class="form-group">'+
                  ...
                  '<input type="text" id="pdisamt'+row+'" name="disamt" class="form-control text-right" value="'+pri_disamt+'/>'+
            ...
            '<div class="row">'+
              '<div class="col-xs-6">'+
                ...
                '<div class="input-group">'+
                  ...
                  '<input type="hidden" id="pri_woref'+row+'" name="pri_woref[]" value="'+pri_woref+'">'+
                  '<span class="input-group-btn" >'+
  ...
  $("#pnetamt"+row+"").val('0');
    ...
    $("#snetamt"+row+"").html("<input type='text' class='txt5 form-control input-sm text-right' name='netamti[]' id='zum4"+row+"' value="+$("#pnetamt"+row+"").val()+" readonly><input type='hidden' name='reamrki[]' value="+$("#premark"+row+"").val()+"><input type='hidden' name='accode[]' value="+$("#accode"+row+"").val()+"><input type='hidden' name='acname[]' value="+$("#acname"+row+"").val()+"><input type='hidden' name='statusass[]' value="+$("#statusass"+row+"").val()+"><input type='hidden' name='type[]' value="+$("#type"+row+"").val()+"><input type='hidden' name='remark_mat[]' value="+$("#remark_mat"+row+"").val()+"><input type='hidden' name='refprno[]' value="+$("#refprno"+row+"").val()+"><input type='hidden' name='pri_woref[]' value="+$("#pri_woref"+row+"").val()+">");

    var sumary_unit = parseFloat($("#summaryunit").val().replace(/,/g,""));
    var rowsum_unit = parseFloat($("#pprice_unit"+row+"").val().replace(/,/g,""));
    var sum_unit = parseFloat(sumary_unit+rowsum_unit);
    $("#summaryunit").val(sum_unit);
    $("#summaryunit2").val(sum_unit);
    var sumary_amt = parseFloat($("#summaryamt").val().replace(/,/g,""));
    var rowsum_amt = parseFloat($("#pamount"+row+"").val().replace(/,/g,""));
    var sum_amt = sumary_amt+rowsum_amt;
    $("#summaryamt").val(sum_amt);
    var sumary_dis = parseFloat($("#summarydis").val().replace(/,/g,""));
    var rowsum_dis = parseFloat($("#pdiscex"+row+"").val());
    var sum_dis = sumary_dis+rowsum_dis;
    $("#summarydis").val(sum_dis);
    var sumary_d1 = parseFloat($("#summaryd1").val().replace(/,/g,""));
    var rowsum_d1 = parseFloat($("#pdiscper1"+row+"").val().replace(/,/g,""));
    var rowsum_d2 = parseFloat($("#pdiscper2"+row+"").val().replace(/,/g,""));
    var rowsum_d3 = parseFloat($("#pdiscper3"+row+"").val().replace(/,/g,""));
    var rowsum_d4 = parseFloat($("#pdiscper4"+row+"").val().replace(/,/g,""));
    var sum_d1 = sumary_d1+rowsum_d1+rowsum_d2+rowsum_d3+rowsum_d4;
    $("#summaryd1").val(sum_d1);

    var sumary_di = parseFloat($("#summarydi").val().replace(/,/g,""));
    var rowsum_di = parseFloat($("#pdisamt"+row+"").val().replace(/,/g,""));
    var sum_di = sumary_di+rowsum_di;
    $("#summarydi").val(sum_di);
    var sumary_vat = parseFloat($("#summaryvat").val().replace(/,/g,""));
    var rowsum_vat = parseFloat($("#to_vats"+row+"").val().replace(/,/g,""));
    var sum_vat = sumary_vat+rowsum_vat;
    $("#summaryvat").val(sum_vat);
    var sumary = parseFloat($("#summarytot").val().replace(/,/g,""));
    var rowsum = parseFloat($("#pnetamt"+row+"").val().replace(/,/g,""));
    ...
    $("#summaryamt").val(sum_amt);
    var sumary_dis = parseFloat($("#summarydis").val().replace(/,/g,""));
    var rowsum_dis = parseFloat($("#pdiscex"+row+"").val().replace(/,/g,""));
    var sum_dis = sumary_dis-rowsum_dis;
    $("#summarydis").val(sum_dis);
  ...
  $('#selectallpr').hide();
      ...
      var tr = '<tr id="'+row+'">'+
        ...
        '<td>'+
          ...
          '</div>'+
        '</td>'+
        ' <td id="smatcode'+row+'" width="10%"><div class="input-group"><input type="text" class="form-control" name="matcodei[]" id="matcodeii'+row+'" required  value="'+pri_matcode+'"><span class="input-group-btn"><a data-toggle="modal" data-target="#edit'+row+'" data-popup="tooltip" title="Edit" id="editfa'+row+'"   class="btn btn-default btn-icon"><i class="icon-search4"></i></a><a class="btn btn-default btn-icon" id="remove'+row+'" data-popup="tooltip" title="" data-original-title="Remove" data-layout="bottomRight" data-type="confirm"><i class="icon-trash"></i></a></i></a></span></div></td>'+
        '<td id="smatname'+row+'">'+pri_matname+'<input type="hidden" name="matnamei[]" id="matnametext'+row+'" value="'+pri_matname+'"></td>'+
        '<td class="text-right" id="scostcode'+row+'">'+pri_costcode+'<input type="hidden" name="costcodei[]" value="'+pri_costcode+'"><input type="hidden" name="costnamei[]" value="'+pri_costname+'"></td>'+
        '<td class="text-right" id="sqtyi'+row+'">'+numberWithCommas(pri_qty)+'<input type="hidden" name="qtyi[]" value="'+pri_qty+'"></td>'+
        '<td class="text-right" id="sunit'+row+'">'+numberWithCommas(pri_unit)+'<input type="hidden" name="uniti[]" value="'+pri_unit+'"></td>'+
        ...
        '<td class="text-right" id="sdisamt'+row+'">'+numberWithCommas(pri_pdiscex)+'<input type="hidden" name="disamti[]" value="'+pri_pdiscex+'">'+
      '</td>'+
      '<td  class="text-right" id="tto_di'+row+'">'+numberWithCommas(pri_disamt)+'<input type="hidden" name="too_di[]" id="zum2'+row+'" value="'+pri_disamt+'">'+
      '<td class="text-right" id="total_vat'+row+'">'+numberWithCommas(pri_tovat)+'<input type="hidden" name="to_vat[]" value="'+pri_tovat+'">'+
      '<td class="text-right" id="snetamt'+row+'">'+numberWithCommas(pri_netamt)+'<input type="hidden" name="netamti[]" value="'+pri_netamt+'">'+
      '<input type="hidden" name="remarki[]" id="sremark'+row+'" value="'+pri_remark+'">'+
      '<input type="hidden" name="accode[]" value="'+pr_assetid+'">'+
