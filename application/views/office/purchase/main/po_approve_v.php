                                    ...
                                    <table class="table table-hover table-striped table-xxs datatable-basic">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th><a class="label label-warning" data-toggle="modal" data-target="#sub<?php echo $value->project_code;?>">Sub
                                                        Project</a></th>
                                                <td><a href="<?php echo base_url(); ?>purchase/purchase_approve/<?php echo $value->project_id; ?>/p/<?php echo $value->project_code; ?>"
                                                        class="label label-primary"><i class="icon-folder-open"></i>
                                                        Select</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    ...
                                    <table class="table table-hover table-striped  table-xxs datatable-basic2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th><a class="label label-warning" data-toggle="modal" data-target="#subd<?php echo $value->project_code;?>">Sub
                                                        Project</a></th>
                                                <td><a href="<?php echo base_url(); ?>purchase/purchase_approve/<?php echo $value->project_id; ?>/p/<?php echo $value->project_code; ?>"
                                                        class="label label-primary"><i class="icon-folder-open"></i>
                                                        Select</a></td>
            ...
            <div class="modal-content">
                        ...
                        <table class="table table-bordered table-xxs table-hover">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="<?php echo base_url(); ?>index.php/petty_cash/newpettycash/<?php echo $keysub->project_id; ?>/p"
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>index.php/data_master/project_sub/<?php echo $val->project_id; ?>"
                        type="submit" class="label label-info">ADD Sub Project <i class="icon-check position-right"></i></a>
