            ...
            <span class="company-logo"></span>
             <div class="row">
                ...
                <div class="form-group">
                    <p style="margin-top:-30px;"> <img src="<?php echo base_url();?>comp/<?php echo $compimg; ?>" class="img-responsive" style="height:45px;"></p>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                    <div class="form-group">
                 ...
                 <div class="panel panel-default" >
                     ...
                     <p class="ex1" style="font-size:10px; margin-top: -10px;">ผู้ขายจะส่งสินค้าให้เป็นตามเงื่อนไขที่ได้เสนอไว้กับบริษัทฯดังต่อไปนี้/supplier shall
                        ...
                        <thead>
                            <tr align="center" >
                            <td>No.</td>
                                <td width="10%;"><p>รหัสวัสดุ <br>Material Code </p></td>
