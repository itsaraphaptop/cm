...
<div id="example" >
            ...
            <span class="company-logo"></span>
             <div class="row">
                ...
                <div class="form-group">
                    <p style="margin-top:-40px;"> <img src="<?php echo base_url();?>comp/<?php echo $compimg; ?>" class="img-responsive" width="10%"></p>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                    <div class="form-group">
                 ...
                 <div class="panel panel-default" >
                     ...
                     <p class="ex1" style="font-size:10px; margin-top: -10px;">ผู้ขายจะส่งสินค้าให้เป็นตามเงื่อนไขที่ได้เสนอไว้กับบริษัทฯดังต่อไปนี้/supplier shall
                        ...
                        <thead style="font-size:10px;">
                            <tr align="center" >
                            <td>No.</td>
                                <td width="3%;"><p>รหัสวัสดุ </p></td>
                                <td width="60%"><p>รายการ </p></td>
                                <td width="5%;"><p>จำนวน </p></td>
                                <td width="5%;"><p>หน่วย </p></td>
                                <td width="8%;"><p>ส่วนลด </p></td>
                                <td width="12%;"><p>ราคาต่อหน่วย </p></td>
                                <td width="15%;"><p>จำนวนเงิน </p></td>
                            </tr>
                        </thead>
 ...
 <p style="margin-top: -25px; font-size: 11px; margin-left: 220px;">กำหนดการชำระเงิน / Term of payment  :    <?php echo $term;?> วัน</p>
        ...
        <p style="font-size: 10px; margin-top: -10px;">หมายเหตุ :  1. การวางบิลและการเก็บเงิน จะต้องแนบใบสั่งซื้อต้นฉบับ มาด้วยทุกครั้ง</p>
