    ...
    $term = $val->vender_credit;
       ...
       $prno = $val->po_prno;
                 ...
                 <span class="company-logo">
                    ...
                    <p style="margin-top:-10px;"> <img src="<?php echo base_url();?>/dist/img/logo.png" class="img-responsive" style="height:45px;">
                    ...
                    <div class="form-group ">
                        ...
                        <p style="font-size:11px; margin-top:-25px; margin-left:270px;" >Page :1/<?php if ($dd==1) {  echo "2"; }else{echo "3";} ?></p>
                    </div>
                        </div><!-- end col-xs-6 -->
                    </div><!-- end row -->
                     ...
                     <p class="ex1" style="font-size:10px; margin-top: -10px;">ผู้ขายจะส่งสินค้าให้เป็นตามเงื่อนไขที่ได้เสนอไว้กับบริษัทฯดังต่อไปนี้/supplier shall
                        ...
                        <thead>
                            <tr align="center" >
                                ...
                                <td width="10%;"><p>รหัสวัสดุ <br>Matetial Code </p></td>
