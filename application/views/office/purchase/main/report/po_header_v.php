...
<div id="example" style="font-size: 9px;">
         ...
         <legend class="legend_custom"></legend>
             <!-- <p class="ex1" style="font-size:11px; margin-top:-15px; margin-left:10px;">  Contact Office 2082 -->
              <!-- ม.10 ถ.สุขุมวิท107 ซ.แบริ่ง 30 ต.สำโรงเหนือ อ.เมืองสมุทรปราการ จ.สมุรปราการ 10270</p> -->
                        ...
                        <div class="form-group" style="margin-left: 280px; margin-top:-1px;font-size:15px;">
                        <p>Purchase Order</p>
                        </div>

                        <div class="form-group" style="margin-left: 315px; margin-top:-15px;font-size:15px;">
                        <p>ใบสั่งซื้อ</p>
                        </div>
                     ...
                     <p class="ex1" style="font-size:10px; margin-top: -10px;">ผู้ขายจะส่งสินค้าให้เป็นตามเงื่อนไขที่ได้เสนอไว้กับบริษัทฯดังต่อไปนี้/supplier shall
                        ...
                        <thead style="font-size:10px;">
                            <tr align="center" >
                                <td>No.</td>
                                <td>รหัสวัสดุ </td>
                                <td class="col-xs-8">รายการ </td>
                                <td>จำนวน </td>
                                <td>หน่วย </td>
                                <td>ส่วนลด </td>
                                <td class="col-xs-2">ราคาต่อหน่วย</td>
                                <td>จำนวนเงิน </td>
                            </tr>
                        </thead>
