<div class="page-header page-header-transparent">
    ...
    <div class="breadcrumb-line breadcrumb-line-component">
        <ul class="breadcrumb">
            ...
            <li class="active">Project-Material List</li>
        </ul>
...
<div class="panel panel-flat">
    <div class="modal-header">
        <h6 class="panel-title"><i class="icon-cog3 position-left"></i> Project-Material List<p></p></h6>
    </div>
    <form action="po_matpro_r" method="get">
    <div class="panel-body">
            <div class="row">
                <div class="col-sm-12">  
                    <label class="control-label col-sm-5" style="text-align: right;">Type Material:</label>
                    <div class="form-group col-sm-2">
                    <select name="typematpro" class="form-control input-sm">
                    <?php foreach ($select as $com): ?>
