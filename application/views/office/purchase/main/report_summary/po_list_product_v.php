...
<div class="panel panel-flat">
	<div class="modal-header">
		<h6 class="panel-title"><i class="icon-cog3 position-left"></i> แสดงการรับสินค้า และค้างรับสินค้า<p></p></h6>
	</div>
	<form action="po_list_product_data" method="get">
	<div class="panel-body">
            ...
            <!-- <div class="row">
                <div class="col-sm-12">  
                    <label class="control-label col-sm-4" style="text-align: right;">PO.No :</label>
                    <div class="form-group col-sm-4">
                    <input type="text" class="form-control input-sm" name="po_no" id="buyname">
                    </div>
                </div> 
            </div> -->
            <!-- <div class="row">
                <div class="col-sm-12">  
                    <label class="control-label col-sm-4" style="text-align: right;">Balance :</label>
                    <div class="form-group col-sm-2">
