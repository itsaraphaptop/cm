...
<div class="content">
    <div class="panel panel-flat">
        <div class="modal-header">
                <h6 class="panel-title"><i class="icon-cog3 position-left"></i> Materials Report Order by Project<p></p></h6>
        </div>
        <form action="po_by_project_r" method="get">
...
function get_project_id(el){
        ...
        var url = "<?=base_url()?>pr_report/get_po_project/"+project_id;
        // alert(url)
        $.post(url, function() {
...
function get_mat_name(matname){
        var url = "<?=base_url()?>pr_report/get_po_project_name/"+matname;
        // alert(url);
        $.post(url, function(){
