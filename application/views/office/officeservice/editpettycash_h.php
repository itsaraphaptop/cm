...
<?php foreach ($data_h as $val) {
	$docno = $val->docno;
	$docdate = $val->docdate;
	$typevender = $val->vender_type;
	$vender = $val->vender;
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="doccode" name="code" value="<?php echo $docno; ?>" placeholder="เลขที่ใบเบิกเงินสด" class="form-control input-sm" readonly="true">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
          ...
          <div class='form-group'>
            <input type="text" name="docdate" value="<?php echo $docdate; ?>" class="form-control input-sm" id="datepicker" />
          </div>
        </div>
        </div>
      </div><!-- end row form -->
        ...
        <div class="col-md-6" >
            <div class="input-group">
             <label for="project1">แผนก</label>
                <input type="text" readonly="true" value="<?php echo $depname; ?>"  class="form-control input-sm input-sm input-sm" id="dptnam">
      ...
      <div class="row"  style="margin-top:15px;">
        ...
        <div class="col-md-9" >
          <div class="input-group">
            ...
            <input type="text" name="vender" id="memname" value="<?php echo $vender; ?>" placeholder="จ่ายให้กับ" class="form-control input-sm">
       ...
       <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea type="text" rows="4" class="form-control input-sm" id="remark" name="remark" placeholder="กรอกรายละเอียด"><?php echo $remark; ?></textarea>
            </div>
          </div>
      </div>
      <div class="row">
...
<div class="row">
                            <div class="col-xs-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="matcodeb6" name="matcode" value="0" placeholder="กรอกรายการซื้อ" class="form-control">
                                  <input type="text" id="matname" name="matname" value="0" placeholder="กรอกรายการซื้อ" class="form-control">
                              </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="input-group">
                                  ...
                                  <input type="text" class="form-control input-sm" readonly="true" placeholder="กรอกชื่อร้านค้า" name="vender" id="vender">
                                  <span class="input-group-btn">
...
$("#editpo").hide();
$("#adddetail").hide();
$('#loaddatadetail').load('<?php echo base_url(); ?>index.php/pettycash/service_pettycash_detail/'+$("#doccode").val());
...
$('.saveprh').click(function(){
  var url="<?php echo base_url(); ?>index.php/pettycash/edit_pettymaster";
  var dataSet={
    doccode: $("#doccode").val(),
