              ...
              <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                              <div class="form-group">
                                        ...
                                        <input type="text" id="amttot" name="amttot" readonly="true" placeholder="กรอกจำนวนเงิน" class="form-control">
                              </div>
                            </div>   
                            <div class="col-xs-2">
                              <div class="form-group">
                                        <label for="addrvender">จำนวนเงิน(vat)</label>
                                        <input type="text" id="netamt" name="netamt" readonly="true" placeholder="กรอกจำนวนเงิน" class="form-control">
                              </div>
                            </div> 
                        ...
                        <div class="row" id="taxchk">
                          ...
                          <label for="">ภาษี</label>
                            <div class="input-group">                              
                              <input type="text" class="taxdate form-control input-sm" id="taxv" readonly="true" placeholder="ภาษี" aria-describedby="basic-addon2">
                          ...
                          <div class="col-xs-3">
                            <div class="from-group">
                              ...
                              <input type="text" class="taxdate form-control input-sm" readonly="true" id="totvat" >
                            </div>
                          </div>
                        </div>
