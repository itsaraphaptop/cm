      ...
      <table id="datasource"  class="table table-striped">
          ...
          <?php foreach ($res as $val) {?>
                  ...
                  <tr>
                      ...
                      <td><button class="btn btn-default btn-block btn-xs" disabled="" data-toggle="modal" data-target="#approvepr<?php echo $val->pr_prno;?>"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span> อนุมัติ</button>  </td>
                      <td><button class="btn btn-default btn-block btn-xs" disabled="" data-toggle="modal" data-target="#disapprove<?php echo $val->pr_prno;?>"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> ไม่อนุมัติ</button>  </td>
                      <?php }else{ ?>
...
<script>
  $('.btnapp').click(function(){
    var url="<?php echo base_url(); ?>index.php/office/approvepr";
      var dataSet={
          prno: $(this).data('app')
        };
