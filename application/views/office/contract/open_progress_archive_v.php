											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center">
														<a href="<?php echo base_url(); ?>management/archive_project_progress/<?php echo $value->project_code; ?>/pgsub"
								...
								<table class="table table-hover table-striped table-xxs datatable-basic">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url(); ?>management/allcontract/<?php echo $value->project_id; ?>/p/subproject"
												 class="label label-primary">
													<i class="icon-folder-open"></i> Select</a>
											</td>
										</tr>
