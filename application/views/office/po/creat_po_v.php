...
<script>
  ...
  $(".openpr").click(function(){
    ...
    $('#loaddetail').load('<?php echo base_url(); ?>index.php/office/service_openpr_detail_null'+'/'+pr);
...
<script>
  ...
  var url="<?php echo base_url(); ?>index.php/po_active/inspodetail";
  var dataSet={
      ponoi: $('.ppono').val(),
...
<script>
  $('#editmaster').click(function(event) {
   var url="<?php echo base_url(); ?>index.php/po_active/editpo";
  var dataSet={
                pono: $('.ppono').val(),
                project : $('#putproject').val(),
                system : $('#system').val(),
