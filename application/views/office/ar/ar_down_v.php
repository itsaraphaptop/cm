...
<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/ar_active/add_invoice">
  <div class="form-group">
    <label>Invoice .:</label>
    <input type="text" class="form-control" readonly="readonly" id="invoice_no" placeholder="Invoice No.">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" readonly="readonly" placeholder="Owner/Customer" name="owner" id="owner">
...
<a href="<?php echo base_url(); ?>ar/ar_main" class="preload btn btn-default"><i class="icon-plus22"></i> New</a>
 <a data-toggle="modal" data-target="#insertrow" class="btn btn-info"><i class="icon-list-numbered"></i> ADD Rows</a>
  <button type="submit" id="saveinv" class="preload btn btn-success"><i class="icon-box-add"></i> Save </button>
</div>
</form>
