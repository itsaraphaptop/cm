<!-- Main content  trans-->
          ...
          <!-- Highlighting rows and columns -->
              ...
              <table id="table_project" class="table table-hover table-bordered table-xxs">
                <thead>
                  <tr>
...
<?php $getproj = $this->db->query("select * from project")->result(); ?>
                  ...
                  <tr>
                    ...
                    <a href="<?php echo base_url(); ?>management/project_budget2/<?php echo $value->project_code; ?>/<?= $value->project_id ?>" class="label label-primary"><i class="icon-folder-open"></i> Select</a>
                    </td>
                  </tr>
