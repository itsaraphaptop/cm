...
<?php 
		//get get_mouth_of_year input start - stop
		//$aray_mouth = get_mouth_of_year($project_start,$project_stop);
				...
				<div class="panel panel-flat">
					...
					<div class="container-fluid">
							<table class="table table-bordered table-responsive">
								...
								<tbody id="content_table_booking">
...
<script type="text/javascript">
	...
	// $(function(){
		$.get('<?=base_url()?>management_active/booking_cost/<?=$project_code?>', function() {
				...
				try{
					...
					//alert(json.content_table);
						...
						$(".show_detail").click(function(event) {
							...
							$.post('<?=base_url()?>management_active/get_detail_booking/', {"mouth":mouth,"type_group":type_group,"project_id":<?=$project_id?> }, function() {
