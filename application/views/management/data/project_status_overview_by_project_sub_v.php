...
// $(document).ready(function(){
	$(".loadoverview").load('<?php echo base_url();?>management/load_dashboard_overview_sub/<?php echo $projedid; ?>/<?php echo $projectcode;?>');
// });
$("#clickoverview").click(function(){
	$(".loadoverview").load('<?php echo base_url();?>management/load_dashboard_overview_sub/<?php echo $projedid; ?>/<?php echo $projectcode;?>');
});
$("#clickloadcontact").click(function(){
	$(".loacontact").load('<?php echo base_url();?>management/load_forcash_contact_sub/<?php echo $projedid; ?>');
});
</script>
