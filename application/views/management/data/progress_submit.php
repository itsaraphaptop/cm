<div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xs-3">
              <div class="form-group">
                ...
                <input type="text" name="refferent" id="refdoc" class="form-control input-xs" value="">
            ...
            <div class="col-xs-2">
              <div class="form-group">
                <label>Date :</label>
                <input type="date" name="date" id="date" class="form-control input-xs" id="date" required="required">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>Year :</label>
                <input type="text" name="year" id="year" class="form-control input-xs" id="year" readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>Month :</label>
                <input type="text" name="month" id="month" class="form-control input-xs" id="month" readonly="true">
              </div>
            </div>
            <div class="col-xs-3">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-2">
              <div class="form-group">
                ...
                <input type="text" name="site_no" id="site_no" class="form-control input-xs" readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" name="after_site_no" id="pjname" value="" class="form-control input-xs" readonly="true">
            ...
            <div class="col-xs-2">
              <div class="form-group">
                ...
                <input type="text" name="customer" class="form-control input-xs" id="cus_id" readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>&nbsp;</label>
                <div class="input-group">
                  <input type="text" name="after_customer" id="cus_name" value="" class="form-control input-xs" readonly="true">
          ...
          <div class="row">
            <div class="col-xs-4">
              <div class="form-group">
                ...
                <input type="text" name="subject_remark" id="subject" class="form-control input-xs" value="">
              </div>
            </div>
            ...
            <div class="col-xs-1">
              <div class="form-group">
                <label>Period :</label>
                <input type="text" name="period" id="period" class="formatnum form-control text-right input-xs" value="">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>Amount Submit :</label>
                <input type="text" name="amount_submit" id="sumjob_amount" class="formatnum form-control input-xs" readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>Amount Certificate :</label>
                <input type="text" name="amount_certificate" id="sumjob_sumcer"  class="formatnum form-control input-xs" readonly="true">
              </div>
            </div>
            <div class="col-xs-2" class="ccdate">
              <div class="form-group">
                <label style="">Certification Date</label>
                <input type="date" name="cdate" id="cdate" class="form-control input-xs" id="date" >
          ...
          <div class="row">
            <div class="col-xs-2">
              <div class="form-group">
                <label>Down :</label>
                <div class="input-group">
                  <input type="text" name="avance" id="avance" class="formatnum form-control text-right input-xs" value="" required="required" readonly="true">
            ...
            <div class="col-xs-2">
              <div class="form-group">
                <label>&nbsp;</label>
                <input type="text" name="after_avance" id="after_avance" class="formatnum form-control text-right input-xs" value="" required="required"  readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>VAT :</label>
                <div class="input-group">
                  <input type="text" name="vat" id="vat" class="formatnum form-control text-right input-xs" value="" required="required" readonly="true">
                  <span class="input-group-addon">%</span>
                </div>
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>&nbsp;</label>
                <input type="text" name="after_vat" id="after_vat" class="formatnum form-control text-right input-xs" value="" required="required"  readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
            ...
            <div class="col-xs-2">
              <div class="form-group">
                <label>Exchang :</label>
                <div class="input-group">
                  <input type="text" name="exchang" id="exchang" class="formatnum form-control text-right input-xs" value="1" required="required">
          ...
          <div class="row">
            <div class="col-xs-2">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" name="retention" id="retention" class="formatnum form-control text-right input-xs" value="" required="required" readonly="true">
                  <span class="input-group-addon">%</span>
                </div>
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>&nbsp;</label>
                <input type="text" name="after_retention" id="after_retention" class="formatnum form-control text-right input-xs" value="" required="required"  readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>W/T :</label>
                <input type="text" name="wt" id="wt" class="formatnum form-control text-right input-xs" value="" required="required" readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>&nbsp;</label>
                <input type="text" name="after_wt" id="after_wt" class="formatnum form-control text-right input-xs" value="" readonly="true"  readonly="true">
              </div>
            </div>
            <div class="col-xs-2">
              <div class="form-group">
                <label>Net Amount :</label>
                <input type="text" name="net_amount" id="net_amount" class="formatnum form-control text-right input-xs" value="" required="required" readonly="true">
              </div>
            </div>
            <div class="col-xs-2" hidden>
              <div class="form-group">
                ...
                <input type="hidden" name="event_type" value="add" id="event_type">
              </div>
            </div>
          </div>
  ...
  $('#project_h').attr('class', 'active');
	$('#project_d').attr('style', 'background-color:#dedbd8');
  </script>