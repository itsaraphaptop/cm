<div class="col-md-9">
    ...
    <script>
        function expensechart() {
        	var url="<?php echo base_url(); ?>management/mange_json";
		      var dataSet={
        ...
        function createChart() {
            ...
            $("#chart_line").kendoChart({
                ...
                series: [{
					...
					field: "amount_submitsum",
                    categoryField: "month_yearaprog",
                    name: "Progress"
                },{
					field: "inprogamount",
                    categoryField: "month_yearin",
                    name: "Invoice"
                },{
					field: "cl_invamtamount",
                    categoryField: "month_yearacl",
                    name: "Income"
				},{
                    field: "priceebud",
                    categoryField: "month_yearb",
                    name: "Budget",
					color: "#5c1cd5"
                },{
                    field: "poi_amount",
                    categoryField: "month_yearpo",
                    name: "Purchase Cost"
                },{
					field: "apvamount",
                    categoryField: "month_yearap",
                    name: "Actual"
                }],
                valueAxis: {
                    line: {
...
<script>
        function ddd() {
				...
				var url="<?php echo base_url(); ?>management/count_lo_open";
						      var dataSet={
						          projecid: "<?php echo $projeid; ?>",
						        };
