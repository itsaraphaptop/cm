<?php foreach ($res as $value) {
  $id = $value->b_code;
  $title =  $value->b_subject;
  $detail = $value->b_detail;
} ?>
...
<div class="container">
        ...
        <div class="panel panel-default">
		        ...
		        <form method="post" action="<?php echo base_url(); ?>index.php/fixbug/edit">
          <div class="row">
            <div class="col-xs-12">
            <!-- <form id="form1" action="<?php echo base_url(); ?>index.php/fixbug/add_bug" method="post" enctype="multipart/form-data"> -->
              <div class="form-group">
                ...
                <input type="text" class="form-control input-sm" placeholder="ชื่อเรื่อง" id="subj" name="subj" value="<?php echo $title; ?>">
              </div>
               <label for="">รายละเอียด</label>
              <div class="form-group">
                <textarea class="form-control input-sm" id="editor1"  name="deti" cols="30" rows="20" placeholder="รายละเอียด"><?php echo $detail; ?></textarea>
              </div>
