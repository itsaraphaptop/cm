...
class add_depreciation extends CI_Controller {
    ...
    public function index()
    {
      ...
      $this->load->view('asset/add_depreciation');
    ...
    $data['res'] = $this->asset_m->depreciationdel($id);
    $this->load->view('asset/deladd_depreciation',$data);
    }
