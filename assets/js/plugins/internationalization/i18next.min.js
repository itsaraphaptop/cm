...
!(function(a) {
	...
	function f(a) {
		var b = function(a) {
			...
			g = function(a, d, e, h) {
				...
				if (
					((i = 'application/json' === j['content-type'] ? JSON.stringify(e.data) : c(e.data)), 'GET' === a)
				) {
					var k = [];
					if (
						(i && (k.push(i), (i = null)),
	...
	function g(a, b) {
		...
		if ((M && M.Deferred && (d = M.Deferred()), !U.resStore)) {
			...
			for (var f = 0, g = U.preload.length; g > f; f++)
				for (var h = Y.toLanguages(U.preload[f]), i = 0, j = h.length; j > i; i++)
		...
		function a(a, b, c) {
			if (0 !== b.length) {
				...
				if ('html' === d)
					...
					(f = U.defaultValueFromContent ? M.extend({ defaultValue: a.attr(d) }, c) : c),
						a.attr(d, M.t(b, f));
			}
		}
		function b(b, c) {
					...
					'html' === d
						...
						: 'text' === d
							...
							: 'prepend' === d
								...
								: 'append' === d ? a.insertAdjacentHTML(F(b, c), 'beforeend') : a.setAttribute(d, F(b, c));
			}
		}
		function b(b, c) {
	...
	function I(a, b) {
		...
		(k =
			'string' == typeof U.postProcess && '' !== U.postProcess
				? [ U.postProcess ]
				: 'array' == typeof U.postProcess || 'object' == typeof U.postProcess ? U.postProcess : []),
	...
	function J(a, b) {
		...
		for (
			var q, r = b.keyseparator || U.keyseparator, s = a.split(r), t = 0, u = f.length;
			u > t && void 0 === q;
			t++
		) {
					...
					if (null === x && U.fallbackOnNull === !0) x = void 0;
						...
						if (U.returnObjectTrees || b.returnObjectTrees) {
							...
							U.objectTreeKeyHandler && 'function' == typeof U.objectTreeKeyHandler
								...
								: ((x = "key '" + h + ':' + a + ' (' + v + ")' returned an object instead of string."),
									Y.log(x));
				} else (x = x.join('\n')), (x = z(x, b)), (x = A(x, b));
		...
		$ = {
			...
			4: function(a) {
				return Number(
					a % 10 == 1 && a % 100 != 11
						? 0
						: a % 10 >= 2 && 4 >= a % 10 && (10 > a % 100 || a % 100 >= 20) ? 1 : 2
				);
			},
			5: function(a) {
				return Number(
			...
			19: function(a) {
				return Number(
					1 == a ? 0 : 0 === a || (a % 100 > 1 && 11 > a % 100) ? 1 : a % 100 > 10 && 20 > a % 100 ? 2 : 3
				);
			},
			20: function(a) {
			...
			get: function(a, b) {
				function c(b, c) {
					...
					if ((d = _.currentRule && _.currentRule.lng === a ? _.currentRule.rule : _.rules[b])) {
						...
						var f = d.numbers[e];
						return (
							2 === d.numbers.length && 1 === d.numbers[0] && (2 === f ? (f = -1) : 1 === f && (f = 1)), f
						);
					}
					return 1 === c ? '1' : '-1';
				}
	...
	ba('sprintf', function(a, b, c) {
		return c.sprintf
			? '[object Array]' === Object.prototype.toString.apply(c.sprintf)
				? da(a, c.sprintf)
				: 'object' == typeof c.sprintf ? ca(a, c.sprintf) : a
			: a;
	}),
		(N.init = g),
		(N.isInitialized = h),
